...
Prediction of sediment transport rates can be corrected with the \emph{hiding-exposure} factor. The classical Meyer-Peter \& M\"uller formula with \emph{hiding-exposure} correction factor $\zeta_i$ is:

...
be set directly by the TBORTBOR variable in the \telkey{BOUNDARY CONDITIONS
FILE},
...
TRACERS} (refer to subsection 6.1.1) and the diffusion schemes \telkey{SCHEME
FOR DIFFUSION OF TRACERS} (refer to subsection 6.1.2) can be modified.

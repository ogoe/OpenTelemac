...
!
      IF(.NOT.TM2S2N2EQUAL) THEN
        TS2 = 43200.D0
        TN2 = 45570.D0
      ELSEIF(TM2S2N2EQUAL.AND.TIDALTYPE.GE.2.AND.TIDALTYPE.LE.6) THEN
        TS2 = TM2
        TN2 = TM2
      ELSE
        IF(LNG.EQ.1) THEN
          WRITE(LU,*) 'OPTION PERIODES DE S2 ET N2 EGALES A DE M2'
          WRITE(LU,*) 'MAUVAISE VALEUR POUR TIDALTYPE =',TIDALTYPE
          WRITE(LU,*) 'ELLE DOIT ETRE COMPRISE ENTRE 1 ET 6'
          WRITE(LU,*) '(MAREE SCHEMATIQUE SEULEMENT)'
        ENDIF
        IF(LNG.EQ.2) THEN
          WRITE(LU,*) 'OPTION PERIODS OF S2 AND N2 EQUAL TO M2'
          WRITE(LU,*) 'UNEXPECTED VALUE FOR TIDALTYPE=',TIDALTYPE
          WRITE(LU,*) 'IT MUST BE CHOSEN BETWEEN 1 AND 6'
          WRITE(LU,*) '(ONLY SCHEMATIC TIDE)'
        ENDIF
        CALL PLANTE(1)
        STOP
      ENDIF

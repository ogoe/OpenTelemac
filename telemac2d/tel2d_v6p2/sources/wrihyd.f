...
!
      ...
      CHARACTER(LEN=*), INTENT(IN) :: TITRE,NOMGEO,NOMLIM
      CHARACTER(LEN=*), INTENT(IN) :: NOMSOU,NOMMAB,NOMCOU,NOMSAL,NOMTEM
      CHARACTER(LEN=*), INTENT(IN) :: NOMINI,NOMVEB,NOMMAF,NOMVEL,NOMVIS

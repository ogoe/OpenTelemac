...
!
      SLUN = DMOD(277.0256206D0+481267.892D0    *TJ+  2.525D-3*TJ**2,
     &            360.D0)
      HSOL = DMOD(280.1895014D0+ 36000.768925D0 *TJ+  3.025D-4*TJ**2,
     &            360.D0)
...
!
      DO I=1,47
        ...
        UPVWAVE(I) = DMOD(UPVWAVE(I),TWOPI)

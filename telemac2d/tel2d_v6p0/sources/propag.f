...
!>    </td></tr>
!>          <tr><td>ADJO
!></td><td>--></td><td>IF YES : ADJOINT MODE
!>    </td></tr>
!>          <tr><td>AGGLOH
...
!>    </td></tr>
!>          <tr><td>TETAD
!></td><td>--></td><td>IMPLICITATION SUR LA DIFFUSION
!>    </td></tr>
!>          <tr><td>TETAH
...
C
C  STARTS COMPUTATION OF SECOND MEMBER CV2
C
...
C
      ELSEIF(ICONVF(1).EQ.ADV_PSI_NC) THEN
C
C STARTS COMPUTATION OF SECOND MEMBER CV3
C
...
C
      ENDIF
C
C ADDS THE TERM AM3 * T1, THEN ASSEMBLY: RESULT IN T2
C HERE AM3 MUST BE MASS/DT POSSIBLY WITH MASS-LUMPING ON U
C
      IF(SOLSYS.EQ.1) THEN

...
C                         1.D-6: LAMINAR VISCOSITY OF WATER
...
!
C ITERATIVE COMPUTATION OF FRICTION VELOCITY UST
! ----------------------------------------------
!
                  UST    = 100.0*VK/DW
                  OLDUST = 0.D0
...
!
C THE ORIGINAL CONDITION FOR LAMINAR/TURBULENT FLOW
C COULD NOT BE HOLD (PROBLEMS DURING NR ITERATION):
! ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
!
            IF(RE.GT.500.D0) THEN
!
C TEST CONDITION: ROUGHNESS LESS THAN FLOW DEPTH
! ----------------------------------------------
!
               IF(CHESTR%R(I) < HC%R(I)) THEN
C                 NDEF : DEFAULT MANNING'S N

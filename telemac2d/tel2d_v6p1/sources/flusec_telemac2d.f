...
!>   </td></tr>
!>     <tr><th> Internal(s)
!>    </th><td> ARR, DEJA, DEP, DIST, DIST1, DIST2, DIST3, ELBEST, ERR, FLX, H1, H2, I1, I2, I3, IEL, IELEM, IELMH, IELMU, IGBEST, ILBEST, ILPREC, ISEC, ISEG, J1, J2, J3, LISTE, NSEC, NSEG, NSEMAX, NX, NY, OK, OLD_METHOD, PT, SUR6, UN1, UN2, VOLNEG, VOLPOS, X1, X2, Y1, Y2
!>   </td></tr>
!>     </table>
...
!>  <br><table>
!>     <tr><th> Known(s)
!>    </th><td> FLUXPR_TELEMAC2D(), MATRIX(), MATVEC(), PLANTE()
!>   </td></tr>
!>     </table>
...
!> </td><td> 16/02/2010
!> </td><td> JAJ, JACEK.JANKOWSKI@BAW.DE
!> </td><td> MODIFIED
!> </td></tr>
!>      <tr>
...
C
      ...
      NSEC = NCP/2
C
C  SEARCHES PATHS JOINING POINT PAIRS:
C
      IF(.NOT.DEJA) THEN
C
C     DYNAMIC ALLOCATION OF FLX, VOLNEG, VOLPOS
C
...
C
          ...
          I2 = IKLE(IELEM,2)
          I3 = IKLE(IELEM,3)
C         IF THE ELEMENT CONTAINS THE SELECTED NODE:

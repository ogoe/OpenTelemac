...
!>  <br><table>
!>     <tr><th> Argument(s)
!>    </th><td> AL, ARL, ARS, AS, AT, DAY, DL, DS, HOUR, MIN, MONTH, SEC, YEAR
!>   </td></tr>
!>     <tr><th> Common(s)
!>    </th><td>
!> INFO : LNG, LU
!>   </td></tr>
!>     <tr><th> Internal(s)
!>    </th><td> AC, API, C, CR, E, EA, EA1, ET, H, I, I0, KSI, L, LS, M, MA, NU, O, OM, P, PI, RT, S, T, TS, UA, VS, X
!>   </td></tr>
!>     </table>
...
!>    </td></tr>
!>          <tr><td>AR L,S
!></td><td><--</td><td>RAPPORT RAYON TERRE / DISTANCE A L'ASTRE
!>    </td></tr>
!>          <tr><td>ARS
!></td><td>---</td><td>
!>    </td></tr>
...
!>    </td></tr>
!>          <tr><td>D  L,S
!></td><td><--</td><td>DECLINAISON DE L'ASTRE
!>    </td></tr>
!>          <tr><td>DS
!></td><td>---</td><td>
!>    </td></tr>
...
!>    </td></tr>
!>          <tr><td>L,S
!></td><td>---</td><td>DESIGNE RESPECTIVEMENT LA LUNE ET LE SOLEIL
!>    </td></tr>
!>          <tr><td>MIN
!></td><td>---</td><td>
!>    </td></tr>
...
!></td><td>---</td><td>
!>    </td></tr>
!>          <tr><td>YEAR,MONTH,DAY
!></td><td>--></td><td>DATE DU CALCUL DES TERMES ASTROS
!>    </td></tr>
!>     </table>
C
C#######################################################################
...
C
C KSI VARIES FROM -12 TO +12 DEGREES IN 18.7 YEARS
C
...
C
C CALCULATES X: TAN(X) = TAN(L-KSI) * COS(I)
C     WITH X BETWEEN 0 AND 2 PI
C

...
!>  <br><table>
!>     <tr><th> Argument(s)
!>    </th><td> ADRESS, DIMENS, DOC, GESTD, LLNG, LLU, MOTATT, MOTCAR, MOTCLE, MOTINT, MOTLOG, MOTREA, NFICDA, NFICMO, NMAX, TROUVE
!>   </td></tr>
!>     <tr><th> Internal(s)
!>    </th><td> DEFATT, DEFCAR, DEFINT, DEFLOG, DEFREA, I, INDIC, NBLANG, RETRY, SIZE, USRATT, USRCAR, USRINT, USRLOG, USRREA, UTINDX
!>   </td></tr>
!>     </table>

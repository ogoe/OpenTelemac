...
C LNHE - 2008
C
C FONCTION : calcule le gradient du noyau d'ordre 5
C FUNCTION : computes the derivative of the fifth order spline kernel
C
...
C
C Calcul le gradient du Kernel 'SPLINE BASED KERNEL' ordre 5
C===========================================================
C Computation of the fifth order spline kernel derivative
C========================================================
C
      DO 201 I=1,NPART
        DO 202 L=1,NLIEN(I)

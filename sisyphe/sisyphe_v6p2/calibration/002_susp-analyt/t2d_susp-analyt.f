! Pour adapter suspension_computation
! ajouter dans les declaration sisyphe : PRIVE
! ajouter la sequence entre SUSPENSION ANALYTIQUE et FIN SUSPENSION ANALYTIQUE
!                    *********************************
...
!
     ...
     &    EX_SUSPENSION_COMPUTATION => SUSPENSION_COMPUTATION
      USE BIEF
      USE DECLARATIONS_SISYPHE, ONLY : FLULIM,PRIVE
      IMPLICIT NONE
      INTEGER LNG,LU
      COMMON/INFO/LNG,LU
...
!
!     NOTE: QSCLXS AND QSCLYS ARE FINALLY USED IN BILAN_SISYPHE
!
...
C
      ...
      TEXTE(28+ADD)='CONC ANALYTIQUE                 '
      TEXTE(29+ADD)='FACTEUR CORRECT                 '

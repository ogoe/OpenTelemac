...
cgl    04.09.2008  scheinbar 
      ALPHA = 1.0D0
cgl   ALPHA = 7.0D0 / ALPHA * XMVE *GRAV
c      ALPHA = 3.5D0  / ALPHA * XMVE *GRAV  ! entspricht alpha = 2.0     => ergab zu wenig Sekundärströmungseffekt
c      ALPHA = 5.25D0 / ALPHA * XMVE *GRAV  ! entspricht alpha = 1.3333
       ALPHA = 6.125D0 / ALPHA * XMVE *GRAV  ! entspricht alpha = 1.1429

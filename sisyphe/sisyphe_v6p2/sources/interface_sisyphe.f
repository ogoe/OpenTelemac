...
C
     ...
     &( E      , ESOMT  , MESH   , MSK    , MASKEL ,
     &  T1     , T2     , S      , IELMU  , VCUMU  , DT     , NPTFR  ,
     &  INFO   , ZFCL_C , ZFCL_S , QSCLXC , QSCLYC , NSICLA ,
     &  VOLTOT , DZF_GF , MASS_GF, LGRAFED, NUMLIQ , NFRLIQ,FLBCLA,VF,
     &  LT     , NIT    , NPOIN  , VOLU2D , CSF_SABLE,MASDEP,MASDEPC,
     &  SUSP )
      USE BIEF
      IMPLICIT NONE
      INTEGER, INTENT(IN)          :: NPTFR,NFRLIQ,IELMU,NSICLA
      INTEGER, INTENT(IN)          :: LT,NIT,NPOIN
      INTEGER, INTENT(IN)          :: NUMLIQ(NPTFR)
      DOUBLE PRECISION, INTENT(IN) :: DT,CSF_SABLE
      LOGICAL, INTENT(IN)          :: MSK,INFO,VF
      LOGICAL,          INTENT(IN)    :: LGRAFED,SUSP
      ...
      DOUBLE PRECISION, INTENT(INOUT) :: MASDEPC(NSICLA)
...
C
     ...
     &  MS_SABLE,MS_VASE,ZF,ZR,AVA0,CONC,NLAYER,DEBU)
      ...
      DOUBLE PRECISION, INTENT(INOUT) :: ES(NPOIN,NOMBLAY),ELAY(NPOIN)

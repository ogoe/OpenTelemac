...
C
      ...
      ENDDO
C
CV V6P2: CONC FROM  28+(NOMBLAY+4)*NSICLA+NOMBLAY TO 27+(NOMBLAY+4)*NSICLA+2*NOMBLAY
C
      DO I=1,NOMBLAY
...
C
C
C     PRIVE: FROM 28+(NOMBLAY+4)*NSICLA+2*NOMBLAY TO
C                 27+(NOMBLAY+4)*NSICLA+MAX(4,NPRIV)+2*NOMBLAY
C
      DO I=1,MAX(4,NPRIV)

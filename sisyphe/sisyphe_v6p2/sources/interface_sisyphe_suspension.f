...
!======================================================================!
     ...
     & VOLU2D,NUMLIQ,NFRLIQ,NPTFR,FLBORTRA)
      ...
      ! ********************************* !
     &  (SLVTRA, HN,HN_TEL,UCONV, VCONV, MU,TOB,FDM, FD90, KSP,KSR,
     ...
     &   T4, T5, T6, T7, T8, T9, T10, T11, T12, T14, W1, TE1, TE2, TE3, 
     &   S, AM1_S, AM2_S, MBOR,MASTEN, MASTOU, MASINI, AC,
! MAK + PAT
     ...
     &   ES,NOMBLAY,CONC_VASE,TOCE_VASE,TOCE_SABLE,
     ...
     &   QSCLXS,QSCLYS)
      ...
      DOUBLE PRECISION, INTENT(IN)    :: FDM, FD90
 ...
 !mak     & ZERO,ZREF,AC,FLUER,CSTAEQ,QSC,ICQ,U2D,V2D,T2,T14,DEBUG)
...
!
      ...
      INTEGER,          INTENT(IN)    :: NPOIN,DEBUG,NOMBLAY
...
!
    ...
    !mak     & QS_S,QS_C,CSTAEQ,ICQ,MASTCP,MASFIN,MASDEPT,MASDEP,MASSOU,
     ...
     & FLBORTRA,NUMLIQ,NFRLIQ,MIXTE,NOMBLAY,CONC_VASE,TOCE_VASE,
     & TOCE_SABLE,FLUER_VASE,TOCE_MIXTE,MS_SABLE,MS_VASE,TASS,DIRFLU)
      ...
      INTEGER,          INTENT(IN)    :: DEBUG,SOLSYS,NOMBLAY
      INTEGER,          INTENT(IN)    :: NUMLIQ(NFRLIQ)
   ...
   !mak      TYPE (BIEF_OBJ),  INTENT(INOUT) :: QSCL_S,QS_S,CSTAEQ
 ...
 ! ***************************** !
      ...
      ! ***************************** !
!
     &  (FDP, FD90, TAUP, NPOIN, GRAV,
!mak     &   XMVE, XMVS, ZERO, AC, CSTAEQ,ZREF,HN,U2D,V2D,T2)
...
!mak      TYPE(BIEF_OBJ),   INTENT(IN)    :: TAUP,ZREF,HN,U2D,V2D,T2
      ...
      INTEGER,          INTENT(IN)    :: NPOIN
      DOUBLE PRECISION, INTENT(IN)    ::  GRAV,  XMVE, XMVS
      DOUBLE PRECISION, INTENT(IN)    :: ZERO,AC, FDP, FD90
      TYPE(BIEF_OBJ),   INTENT(INOUT) :: CSTAEQ
!

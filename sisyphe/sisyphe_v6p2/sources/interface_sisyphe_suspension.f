...
!======================================================================!
     ...
     &   QSCLXS,QSCLYS)
      ...
      DOUBLE PRECISION, INTENT(INOUT) :: ES(NPOIN,NLAYMAX),TOCE_SABLE
      DOUBLE PRECISION, INTENT(INOUT) :: CONC_VASE(NCOUCH_TASS)
      DOUBLE PRECISION, INTENT(INOUT) :: TOCE_VASE(NCOUCH_TASS)
...
!
      ...
      INTEGER,          INTENT(IN)    :: NPOIN,DEBUG,NCOUCH_TASS
...
!
     ...
     &   NCOUCH_TASS,DT,TOCE_MIXTE,MS_SABLE,MS_VASE)
      ...
      DOUBLE PRECISION, INTENT(IN)    :: ZERO, PARTHENIADES
      TYPE (BIEF_OBJ),  INTENT(IN)    :: ZREF
      DOUBLE PRECISION, INTENT(INOUT) :: AC,AVAIL(NPOIN,NLAYMAX,NSICLA)
      DOUBLE PRECISION, INTENT(INOUT) :: ES(NPOIN,NLAYMAX)
      ...
      DOUBLE PRECISION,  INTENT(INOUT) :: MS_VASE(NPOIN,NCOUCH_TASS)
      DOUBLE PRECISION,  INTENT(INOUT) ::TOCE_MIXTE(NPOIN,NCOUCH_TASS)
      DOUBLE PRECISION, INTENT(IN)      :: DT
      TYPE(BIEF_OBJ),   INTENT(IN)       ::  QSC
      INTEGER,          INTENT (IN)      :: ICQ
      DOUBLE PRECISION, INTENT(IN)     :: TOCE_VASE(NCOUCH_TASS)

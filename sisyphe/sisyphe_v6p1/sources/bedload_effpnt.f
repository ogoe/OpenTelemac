...
!
C
C NOTE JMH : IF WE SWAP THE DEVIA AND THE SLOPEFF ACTIONS BELOW
C            IT IS PROBABLY NOT USEFUL TO DO A COPY OF CALFA AND SALFA ?
C
C     COS AND SIN TETA (CALFA AND SALFA HAVE ALREADY BEEN COMPUTED
C                       IN BEDLOAD_SOLIDISCHARGE, SO JUST A COPY HERE)

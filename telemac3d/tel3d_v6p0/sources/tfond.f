...
!>  <br><table>
!>     <tr><th> Argument(s)
!>    </th><td> AUBOR, CF, GRAV, HN, IPBOT, KARMAN, KFROT, LISRUG, NONHYD, NPLAN, NPOIN, OPTBAN, PROPNU, RUGOF, U2D, U3D, UETCAR, V2D, V3D, W3D, Z
!>   </td></tr>
!>     <tr><th> Common(s)
!>    </th><td>
!> INFO : LNG, LU
!>   </td></tr>
!>     <tr><th> Internal(s)
!>    </th><td> DIST, I1, IT, N, UETUTA, UTANG, VNORM, YPLUS
!>   </td></tr>
!>     </table>
...
!>    </td></tr>
!>          <tr><td>KFROT
!></td><td>--></td><td>LAW OF BOTTOM FRICTION
!>    </td></tr>
!>          <tr><td>LISRUG
...
!>    </td></tr>
!>          <tr><td>UETCAR
!></td><td><--</td><td>(FRICTION VELOCITY)**2
!>    </td></tr>
!>          <tr><td>UN , VN
...
C           1.D-6 TO AVOID LOG(0) ON TIDAL FLATS
            DIST  = MAX(( Z(NPOIN+I1)-Z(I1) ),1.D-6)
...
402       FORMAT(1X,'TFOND : LOI DE FROTTEMENT INCONNU : ',1I6)

...
!>  <br><table>
!>     <tr><th> Argument(s)
!>    </th><td> HN, KARMAN, LM, NPLAN, NPOIN2, NPOIN3, NTRAC, P1, P2, P3, TA, U, V, X, Y, Z
!>   </td></tr>
!>     <tr><th> Common(s)
!>    </th><td>
!> INFO : LNG, LU
!>   </td></tr>
!>     <tr><th> Internal(s)
!>    </th><td> COSA, DELT, EPS, I, I3D, I3DI, I3DM, I3DMIN, I3DS, ICHINF, ICHSUP, IMAX, IMIN, IPLAN, LMN, SINA, TAMAX, VIT, VMAX, VMIN, ZCHINF, ZCHSUP, ZINT, ZMAX
!>   </td></tr>
!>     </table>
...
!>    </td></tr>
!>          <tr><td>LM2
!></td><td><--</td><td>CARRE DE LA LONGUEUR DE MELANGE
!>    </td></tr>
!>          <tr><td>NPLAN
...
!>    </td></tr>
!>          <tr><td>TA
!></td><td>--></td><td>CONCENTRATIONS DES TRACEURS ACTIFS
!>    </td></tr>
!>          <tr><td>U,V
!></td><td>--></td><td>VITESSE HORIZONTALE
!>    </td></tr>
!>          <tr><td>X,Y
!></td><td>--></td><td>COORDONNEES HORIZONTALES
!>    </td></tr>
!>          <tr><td>Z
...
C
                        SUBROUTINE LONGMB
     &(LM,Z,HN,NPOIN3,NPOIN2,NPLAN,U,V,X,Y,P1,P2,P3,NTRAC,TA,KARMAN)
C
C~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
C| HN             |-->| HAUTEUR D'EAU
C| KARMAN         |---| 

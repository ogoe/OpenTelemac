!>  @par Use(s)
!><br>BIEF_DEF, DECLARATIONS_TELEMAC3D
...
C
      INTERFACE
        SUBROUTINE GRAD2D
     & (DFDX, DFDY, FU, IPLAN, SVIDE,
     &  TRAV2, FU2, IELM2, MESH2D, MSK, MASKEL)
          USE BIEF_DEF
          IMPLICIT NONE
          TYPE(BIEF_OBJ), INTENT(INOUT) :: DFDX, DFDY
          TYPE(BIEF_OBJ), INTENT(IN)    :: FU
          TYPE(BIEF_OBJ), INTENT(INOUT) :: TRAV2, FU2, SVIDE
          TYPE(BIEF_OBJ), INTENT(IN)    :: MASKEL
          TYPE(BIEF_MESH), INTENT(INOUT):: MESH2D
...
C
      INTERFACE
        SUBROUTINE PREDIV(PD,UP,VP,WP,INFO,BC)
          USE BIEF_DEF
          IMPLICIT NONE
...
C
     ...
     &  LATIT, LONGIT, NORD,SMU,SMV,YASEM3D,SCHCVI,DENLAW)
      ...
      INTEGER, INTENT(IN) :: LV, LT,IELM2H,NREJEU
      INTEGER, INTENT(IN) :: IELM3,SCHCVI,DENLAW
      ...
      DOUBLE PRECISION, INTENT(INOUT) :: TR1(NPOIN3)
      DOUBLE PRECISION, INTENT(INOUT) :: TR2(NPOIN3), TR3(NPOIN3)
      TYPE(BIEF_OBJ),   INTENT(INOUT) :: STR1, STR2, STR3

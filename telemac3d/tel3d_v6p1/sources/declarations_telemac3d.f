...
C composantes de la vitesse apres convection
...
C composantes de la vitesse apres diffusion
...
C termes sources explicites pour la vitesse
...
C termes sources imlicites pour la vitesse
...
C k (energie turbulente) du modele k-epsilon au pas de temps precedent (n)
      TYPE(BIEF_OBJ), TARGET :: AKN
!> @brief K OF K-EPSILON MODEL AFTER ADVECTION
C k (energie turbulente) du modele k-epsilon apres convection
      TYPE(BIEF_OBJ), TARGET :: AKC
!> @brief K OF K-EPSILON MODEL AT TIME N+1
C k (energie turbulente) du modele k-epsilon au temps n+1
      TYPE(BIEF_OBJ), TARGET :: AK
!> @brief
C terme source explicite pour k du modele k-epsilon
      TYPE(BIEF_OBJ), TARGET :: S0AK
!> @brief
C terme source implicite pour k du modele k-epsilon
...
C
!> @brief
C tableau de travail de dimension npoin3
...
C tableau de travail de dimension npoin2

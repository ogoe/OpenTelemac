...
\begin{figure} [!h]
\centering
\includegraphicsmaybe{[scale=0.55]}{../img/EvolutionR05.png}
 \caption{Comparison of simulated (coloured) and measured (black contour lines) normalized bed evolution.}\label{fig:results1}
\end{figure}

\begin{figure} [!h]
\centering
\includegraphicsmaybe{[scale=0.25]}{../img/sis_yen-exp_90.png}
\includegraphicsmaybe{[scale=0.25]}{../img/sis_yen-exp_180.png}
...
\begin{figure} [!h]
\centering
\includegraphicsmaybe{[width=.96\textwidth]}{../img/EvolutionR05.png}
 \caption{Comparison of simulated (coloured) and measured (black contour lines) normalized bed evolution.}\label{fig:results1}
\end{figure}

\begin{figure} [!h]
\centering
\includegraphicsmaybe{[width=.96\textwidth]}{../img/sis_yen-exp_90.png}
\includegraphicsmaybe{[width=.96\textwidth]}{../img/sis_yen-exp_180.png}

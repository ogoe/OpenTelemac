...
\begin{figure} [!h]
\centering
\includegraphicsmaybe{[width=0.85\textwidth]}{../section1d.png}
...
\begin{figure} [!h]
\centering
\includegraphicsmaybe{[width=0.85\textwidth]}{../mesh.png}
%\includegraphics{bathy.png}
...
\begin{figure} [!h]
\centering
\includegraphicsmaybe{[width=0.5\textwidth]}{../results3.png}
 \caption{Significative wave heigths for Roelvink’s model}
\label{resultbj3}
\end{figure}
\begin{figure} [!h]
\centering
\includegraphicsmaybe{[width=0.5\textwidth]}{../results4.png}

...
results are compared to laboratory data \cite{battjes}
%
\subsubsection{Description of the problem}
%
Our test case corresponds to the ``run 15'' in Battles and Janssen
\cite{battjes}. It is a rectilinear beach with a bar. The bathymetry of that
...
%
The Battjes and Janssen's experimets were conducted in a channel and in
...
%
The domain is a 25m by 12m rectangle. The depth is constant over $y$ and
...
prescribedat the west of the domain with a boundary peak frequency of 0.53Hz, a
significative heigth of 0.202m and a boundary peak factor of 3.3. The boundary
...
%
The time duration is 35s with a time step of 0.35s, the spectro-angular mesh
...
%
The Figure \ref{resultbj} displays the significant wave heights as computed by
...
spectro-angular energy spread. The energy transferts of the pre-breaking are
...
The effect on the mean frequency can be neglicted.

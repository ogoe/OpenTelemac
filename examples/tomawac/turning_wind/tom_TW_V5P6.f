...
!                                                                      C
!  Nom du cas : CAS DE VENT TOURNANT DE 60 DEG. (SANS PROPAGATION).    C
!               EXECUTION EN MODE TROISIEME GENERATION.                C
!                                                                      C
!  Ce fichier contient les subroutines suivantes :                     C
!   ANAVEN : affectation de la vitesse du vent (variable en temps)     C
!                                                                      C
!   Faire une recherche de CMB pour trouver les parties modifiees.     C
!                                                                      C
!                          Michel BENOIT (EDF R&D LNHE)   10/12/2004   C
!======================================================================C
!
!                       *****************
                        SUBROUTINE ANAVEN

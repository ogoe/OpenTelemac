\subsection{Fetch-limited growth}
%
...
\subsubsection{TOMAWAC Results - infinite depth }
...
\begin{figure}[H]
  \centering
  	\includegraphics[width=0.5\textwidth]{M0*v10id.pdf}\includegraphics[width=0.5\textwidth]{M0*v20id.pdf}\\

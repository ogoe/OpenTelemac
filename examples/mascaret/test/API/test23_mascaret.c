...
int test23_mascaret(char *pathTest,int iter)
{
    ...
    char *FileType[] = {"xcas","geo","loi","loi","loi","loi","loi","listing","res"};
    char    **FileName;
    ...
    strcat(fullpath,"/Test23/data/xml/");
    ...
    strcat(FileName[5],fullpath);
    strcat(FileName[5],"mascaret0_3.loi");
    strcat(FileName[6],fullpath);
    strcat(FileName[6],"mascaret0_4.loi");
    strcat(FileName[7],"mascaret0.lis");
    ...
    /* MASCARET import */
    err = C_IMPORT_MODELE_MASCARET(id,FileName, FileType,9,print);
    if(err) return err;

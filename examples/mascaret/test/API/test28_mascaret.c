...
int test28_mascaret(char *pathTest,int iter)
{
    ...
    char *FileType[] = {"xcas","geo","loi","loi","loi","loi","listing","res"};
    char    **FileName;
    ...
    strcat(fullpath,"/Test28/data/xml/");
    ...
    strcat(FileName[6],"mascaret0.lis");
    strcat(FileName[7],"mascaret0_ecr.opt");
    ...
    /* MASCARET import */
    err = C_IMPORT_MODELE_MASCARET(id,FileName, FileType,8,print);
    if(err) return err;

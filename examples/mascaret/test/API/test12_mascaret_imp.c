...
int test12_mascaret_imp(char *pathTest,int iter)
{
    ...
    char *FileType[] = {"xcas","geo","loi","loi","listing","res"};
    char    **FileName;
    ...
    strcat(fullpath,"/Test12/data/MASCARET_IMPLICITE/xml/");
    ...
    strcat(FileName[4],"mascaret0.lis");
    strcat(FileName[5],"mascaret0_ecr.opt");
    ...
    /* MASCARET import */
    err = C_IMPORT_MODELE_MASCARET(id,FileName, FileType,6,print);
    if(err) return err;

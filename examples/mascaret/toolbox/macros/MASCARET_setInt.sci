...
//      valeur      : nouvelle valeur de la variable pour les indexes specifies (sous la forme d'un entier)
function [erreur]=MASCARET_setInt(id,nomVar,index1,index2,index3,valeur)
    tailleNomVar=40
    nomVarComplete=fillString(nomVar,tailleNomVar)
    [erreur]=fort("set_int_mascaret",id,2,"i",nomVarComplete,3,"c",index1,4,"i",index2,5,"i",index3,6,"i",valeur,7,"i","out",[1,1],1,"i");
    return
endfunction
...
function [erreur]=MASCARET_setBool(id,nomVar,index1,index2,index3,valeur)
    tailleNomVar=40
    ...
    [erreur]=fort("set_bool_mascaret",id,2,"i",nomVarComplete,3,"c",index1,4,"i",index2,5,"i",index3,6,"i",valeurFortran,7,"i","out",[1,1],1,"i");
    return
endfunction
...
// Accesseur permettant d'acceder aux valeurs entieres des variables d'une instance du modele ou de l'etat
// Arguments en entree :
...
// Argument en sortie :
//      valeur       : valeur entiere de la variable pour les indexes specifies
function [erreur,valeur]=MASCARET_getInt(id,nomVar,index1,index2,index3)
    tailleNomVar=40
    nomVarComplete=fillString(nomVar,tailleNomVar)
    [erreur,valeur]=fort("get_int_mascaret",id,2,"i",nomVarComplete,3,"c",index1,4,"i",index2,5,"i",index3,6,"i","out",[1,1],1,"i",[1,1],7,"i");
    return
endfunction
...
path_xml = "file://"+toolbox_dir+c+".."+c+"test"+c+"Test_Plan"+c+"Test20"+c+"data"+c+"xml"+c+"mascaret0.xcas";
TabNomFichier = [
                 strsubst(path_xml,'\','/'), ..
                 toolbox_dir+c+".."+c+"test"+c+"Test_Plan"+c+"Test20"+c+"data"+c+"xml"+c+"mascaret0.geo", ..
                 toolbox_dir+c+".."+c+"test"+c+"Test_Plan"+c+"Test20"+c+"data"+c+"xml"+c+"mascaret0_0.loi", ..
                 toolbox_dir+c+".."+c+"test"+c+"Test_Plan"+c+"Test20"+c+"data"+c+"xml"+c+"mascaret0_1.loi", ..
...
// initialisation
erreur = MASCARET_initStateName(id,toolbox_dir+c+".."+c+"test"+c+"Test_Plan"+c+"Test20"+c+"data"+c+"xml"+c+"mascaret0.lig",impression);
assert_checkequal(erreur,0);
...
ResRef = read(toolbox_dir+c+".."+c+"test"+c+"Test_Plan"+c+"Test20"+c+"ref"+c+"res.txt",nbSec,5);

// test de la solution sur le debit / solution analytique
code_retour = assert_checkalmostequal(Q,ResRef(:,3),%eps,1.04D0);
...
code_retour = assert_checkalmostequal(Z,ResRef(:,2),3.D-2,0.14D0);
assert_checktrue(code_retour);

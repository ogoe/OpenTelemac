...
path_xml = "file://"+toolbox_dir+c+".."+c+"test"+c+"Test_Plan"+c+"Test16"+c+"data"+c+"MASCARET_CHOC"+c+"xml"+c+"mascaret0.xcas";
TabNomFichier = [
                 strsubst(path_xml,'\','/'), ..
                 toolbox_dir+c+".."+c+"test"+c+"Test_Plan"+c+"Test16"+c+"data"+c+"MASCARET_CHOC"+c+"xml"+c+"mascaret0.geo", ..
                 toolbox_dir+c+".."+c+"test"+c+"Test_Plan"+c+"Test16"+c+"data"+c+"MASCARET_CHOC"+c+"xml"+c+"mascaret0_0.loi", ..
                 toolbox_dir+c+".."+c+"test"+c+"Test_Plan"+c+"Test16"+c+"data"+c+"MASCARET_CHOC"+c+"xml"+c+"mascaret0_1.loi", ..
...
// initialisation
erreur = MASCARET_initStateName(id,toolbox_dir+c+".."+c+"test"+c+"Test_Plan"+c+"Test16"+c+"data"+c+"MASCARET_CHOC"+c+"xml"+c+"mascaret0.lig",impression);
assert_checkequal(erreur,0);
...
code_retour = assert_checkalmostequal(Q,0.18*ones(nbSec,1),%eps,2.D-3);
assert_checktrue(code_retour);

// test de la solution sur le debit au dernier pas de temps / solution de reference anterieure
code_retour = assert_checkalmostequal(Q,ResRef1(:,4),%eps,2.D-3);
assert_checktrue(code_retour);

// test de la solution sur la cote au dernier pas de temps
code_retour = assert_checkalmostequal(Z,ResRef1(:,3),%eps,3.D-3);
assert_checktrue(code_retour);

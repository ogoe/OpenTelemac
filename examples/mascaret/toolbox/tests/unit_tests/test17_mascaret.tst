...
path_xml = "file://"+toolbox_dir+c+".."+c+"test"+c+"Test_Plan"+c+"Test17"+c+"data"+c+"MASCARET"+c+"xml"+c+"mascaret0.xcas";
TabNomFichier = [
                 strsubst(path_xml,'\','/'), ..
                 toolbox_dir+c+".."+c+"test"+c+"Test_Plan"+c+"Test17"+c+"data"+c+"MASCARET"+c+"xml"+c+"mascaret0.geo", ..
                 toolbox_dir+c+".."+c+"test"+c+"Test_Plan"+c+"Test17"+c+"data"+c+"MASCARET"+c+"xml"+c+"mascaret0_0.loi", ..
                 toolbox_dir+c+".."+c+"test"+c+"Test_Plan"+c+"Test17"+c+"data"+c+"MASCARET"+c+"xml"+c+"mascaret0_1.loi", ..
...
// initialisation
erreur = MASCARET_initStateName(id,toolbox_dir+c+".."+c+"test"+c+"Test_Plan"+c+"Test17"+c+"data"+c+"MASCARET"+c+"xml"+c+"mascaret0.lig",impression);
assert_checkequal(erreur,0);
...
ResRef = read(toolbox_dir+c+".."+c+"test"+c+"Test_Plan"+c+"Test17"+c+"ref"+c+"res.txt",nbSec,3);

// test de la solution sur le debit au dernier pas de temps / solution analytique
code_retour = assert_checktrue(max(Q)<22.6);
assert_checktrue(code_retour);
code_retour = assert_checktrue(min(Q)>=19.99);
assert_checktrue(code_retour);

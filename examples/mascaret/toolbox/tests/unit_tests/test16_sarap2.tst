...
path_xml = "file://"+toolbox_dir+c+".."+c+"test"+c+"Test_Plan"+c+"Test16"+c+"data"+c+"SARAP_SANS_CHOC"+c+"xml"+c+"mascaret0.xcas";
TabNomFichier = [
                 strsubst(path_xml,'\','/'), ..
                 toolbox_dir+c+".."+c+"test"+c+"Test_Plan"+c+"Test16"+c+"data"+c+"SARAP_SANS_CHOC"+c+"xml"+c+"mascaret0.geo", ..
                 toolbox_dir+c+".."+c+"test"+c+"Test_Plan"+c+"Test16"+c+"data"+c+"SARAP_SANS_CHOC"+c+"xml"+c+"mascaret0_0.loi", ..
                 toolbox_dir+c+".."+c+"test"+c+"Test_Plan"+c+"Test16"+c+"data"+c+"SARAP_SANS_CHOC"+c+"xml"+c+"mascaret0_1.loi", ..
...
[erreur,Q] = getDoubleMASCARET(id,"State.Q",20,0,0); // section no. 20 au hasard
assert_checkequal(erreur,0);

ResRef = read(toolbox_dir+c+".."+c+"test"+c+"Test_Plan"+c+"Test16"+c+"ref"+c+"res1.txt",nbSec,7);

// test de la solution sur le debit
code_retour = assert_checkequal(Q,1.53);

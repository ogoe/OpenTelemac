...
// initialisation
erreur = initStateNameMASCARET(id,toolbox_dir+c+".."+c+"test"+c+"Test_Plan"+c+"Test14"+c+"data"+c+"xml"+c+"mascaret0.lig",impression);
assert_checkequal(erreur,0);
...
[erreur,Q5000(1)] = getDoubleMASCARET(id,"State.Q",11,0,0); // section amont
assert_checkequal(erreur,0);
[erreur,Q10000(1)] = getDoubleMASCARET(id,"State.Q",21,0,0); // section intermediaie
assert_checkequal(erreur,0);
[erreur,Q15000(1)] = getDoubleMASCARET(id,"State.Q",31,0,0); // section aval
assert_checkequal(erreur,0);
...
while (tpsCalcul <= TF)
  ...
  [erreur,Q5000(i)] = getDoubleMASCARET(id,"State.Q",11,0,0);
  assert_checkequal(erreur,0);
  [erreur,Q10000(i)] = getDoubleMASCARET(id,"State.Q",21,0,0);
  assert_checkequal(erreur,0);
  [erreur,Q15000(i)] = getDoubleMASCARET(id,"State.Q",31,0,0);
  assert_checkequal(erreur,0);
  i = i + 1;
end

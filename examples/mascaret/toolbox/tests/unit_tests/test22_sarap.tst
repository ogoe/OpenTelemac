...
path_xml = "file://"+toolbox_dir+c+".."+c+"test"+c+"Test_Plan"+c+"Test22"+c+"data"+c+"SARAP"+c+"xml"+c+"mascaret0.xcas";
TabNomFichier = [
                 strsubst(path_xml,'\','/'), ..
                 toolbox_dir+c+".."+c+"test"+c+"Test_Plan"+c+"Test22"+c+"data"+c+"SARAP"+c+"xml"+c+"mascaret0.geo", ..
                 toolbox_dir+c+".."+c+"test"+c+"Test_Plan"+c+"Test22"+c+"data"+c+"SARAP"+c+"xml"+c+"mascaret0_0.loi", ..
                 toolbox_dir+c+".."+c+"test"+c+"Test_Plan"+c+"Test22"+c+"data"+c+"SARAP"+c+"xml"+c+"mascaret0_1.loi", ..
...
// test de la solution sur le debit total
code_retour = assert_checkalmostequal(Q,9100.0*ones(1:nbSec)',%eps,1.D-10);
assert_checktrue(code_retour);

// test de la solution sur le debit mineur / solution anterieure de reference
code_retour = assert_checkalmostequal(Q1,ResRef(:,3),%eps,1.D-3);
assert_checktrue(code_retour);

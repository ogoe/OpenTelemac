...
\begin{figure} [H]
\centering
\includegraphicsmaybe{[scale=0.8]}{../img/lock\_exchange\_mesh.pdf}
...
\begin{figure} [H]
\centering
\includegraphicsmaybe{[scale=0.8]}{../img/lock\_exchange\_NH\_res.pdf}
...
\begin{figure} [h]
\centering
\includegraphicsmaybe{[scale=0.8]}{../img/lock\_exchange\_hydro\_res.pdf}

...
!
      IF(LT.EQ.1) THEN
        DO K=1,NPTFR
          ...
          ! Define the velocity on boundary ??
          IF(I.EQ.2011.OR.I.EQ.2061.OR.
     &       I.EQ.2060.OR.I.EQ.2059.OR.
     &       I.EQ.2058.OR.I.EQ.2057.OR.
     &       I.EQ.2012) THEN
            UBOR(K,1) = 0.1711D0
            UBOR(K,2) = 0.1711D0
            VBOR(K,1) = -0.2443D0
          ...
          Y2 = 0.8
          ! Define the velocity on boundary ??
          IF(I.EQ.1507.OR.I.EQ.1563.OR.
     &       I.EQ.1562.OR.I.EQ.1561.OR.
     &       I.EQ.1559.OR.I.EQ.1558.OR.
     &       I.EQ.1557.OR.I.EQ.1508.OR.
     &       I.EQ.1560) THEN
            UBOR(K,1) = 1.0D0
            UBOR(K,2) = 1.0D0
          ENDIF

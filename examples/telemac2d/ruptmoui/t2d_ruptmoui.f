...
C                                                                       
C***********************************************************************
C PROGICIEL : TELEMAC        07/12/88    F. LEPEINTRE (LNH) 30 71 80 18 
C                                                                       
C***********************************************************************
C                                                                       
C     FONCTION  : SOLUTION EXACTE DE LA RUPTURE DE BARRAGE SUR          
C                 FOND MOUILLE, DANS UN RECTANGLE.                      
C                                                                       
C     ATTENTION AUX CONVENTIONS :    ******                             
C                                    *    *     ^                       
C                                    *    *     |                       
C                                    *    * JM  | X                     
C                                    *    *     |                       
...
C |   H            |<-- | HAUTEUR D'EAU.                                
C |   V            |<-- | VITESSE EXACTE.                               
C |   YG           | -->| HAUTEUR D'EAU A GAUCHE DU BARRAGE.            
C |   YD           | -->| HAUTEUR D'EAU A DROITE DU BARRAGE.            
C |   X            | -->| COORDONNEES DES POINTS (BARRAGE EN 0.)        
C |   T            | -->| TEMPS (DEPART A 0.)                           
C |________________|____|______________________________________________ 
C MODE : -->(DONNEE NON MODIFIEE), <--(RESULTAT), <-->(DONNEE MODIFIEE) 
C-----------------------------------------------------------------------
C                                                                       
C   SOUS-PROGRAMMES APPELES : DEGRE3, FONCTION FC1                      
C                                                                       
C***********************************************************************
C                                                                       
      IMPLICIT NONE                                                     
...
C-----------------------------------------------------------------------
C                                                                       
C     CALCUL DES VALEURS INITIALES DE LA SITUATION THEORIQUE            
C     ------------------------------------------------------            
C
      IM=21
      JM=81
C                                                                       
      ...
      CD = SQRT(G*YD)                                                   
C                                                                       
C     VITESSE URG ET TIRANT D EAU YRG A GAUCHE DU RESSAUT:              
C                                                                       
      EPS    = 0.D0                                                     
      BG     = CG                                                       
      BD     = CD                                                       
...
C                                                                       
C           ---------------------------                                 
C           |VIII) VALEURS THEORIQUES |                                 
C           ---------------------------                                 
C                                                                       
C                                                                       
C           DANS LE PLAN (X,T)                                          
C           ON APPELLE C L'INTERSECTION A T AVEC X = -CG*T              
C                      D L'INTERSECTION A T AVEC X = (URG - CRG)*T      
C                      E L'INTERSECTION A T AVEC X =  WR*T              
C                                          WR:VITESSE DU RESSAUT        
C                A ET B LES LIMITES DU DOMAINE D'ETUDE                  
C                A GAUCHE DE C , EAU IMMOBILE DE COTE YG                
C                ENTRE C ET D , ONDE DE DETENTE                         
C                ENTRE D ET E, EAU A VITESSE URG DE COTE (CRG**2)/G     
C                A DROITE DE E , EAU IMMOBILE DE COTE YD                
C                                                                       
C           ABSCISSES DES POINTS C , D ET E                             
            XC = -CG * T                                                
            XD = (URG - CRG) * T                                        
            XE = WR * T                                                 
C                                                                       
...
C***********************************************************************
C                                                                       
C     FONCTION  : FONCTION APPELEE PAR LE SOUS-PROGRAMME EXACTE         
C                 DU CAS-TEST RUPTURE DE BARRAGE SUR FOND MOUILLE       
C                                                                       
C-----------------------------------------------------------------------
C                             ARGUMENTS                                 
C .________________.____.______________________________________________ 

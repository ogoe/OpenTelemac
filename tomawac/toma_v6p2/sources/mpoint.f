...
!     """""""""""""""
      ...
      INTEGER I1_P(NPLOT), I1_T(NPLOT)
      DOUBLE PRECISION EPSILO, EPSI, EPM1, COEF1, COEF2, DEUPI
      DOUBLE PRECISION U_MP(NPLOT), V_MP(NPLOT), W_MP(NPLOT)
      DOUBLE PRECISION XPLOT_IN(NPLOT), YPLOT_IN(NPLOT)
      DOUBLE PRECISION ZPLOT_IN(NPLOT)

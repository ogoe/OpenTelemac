...
!
     ...
     & NPOIN2 , NELEM2 , NPLAN  , IFF , NF  ,IFABOR,GOODELT)
      ...
      DOUBLE PRECISION SHP(3,NPOIN2,NPLAN),SHT(NPOIN2,NPLAN)
...
!
     ...
     & ELI , KNOGL , KNI , NELE2L , NPOI2L ,IFABOR,GOODELT)
      ...
      DOUBLE PRECISION SHP(3,NPOI2L,NPLAN),SHZ(NPOI2L,NPLAN)
        END SUBROUTINE
      END INTERFACE
!
!-----------------------------------------------------------------------
...
!
     ...
     &   ETAP1, NPOIN2 , NELEM2 , NPLAN , TRA01)
      ...
      DOUBLE PRECISION SHP(3,NPOIN2,NPLAN),SHZ(NPOIN2,NPLAN)

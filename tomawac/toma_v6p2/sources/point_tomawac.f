...
!
      CALL ALMESH(MESH3D,'MESH3D',IELM3,SPHE,CFG,WAC_FILES(WACGEO)%LU,
     &            EQUA,NPLAN=NPLAN,FILE_FORMAT=WAC_FILES(WACGEO)%FMT)
!
...
!
!     NOTE JMH: ST0 IS USED ONLY AS A VOID STRUCTURE...

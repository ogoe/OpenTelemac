...
!                                              NOT NPTFR, SEE TRACVF
      DOUBLE PRECISION, INTENT(IN)    :: FXBOR(NPOIN),PLUIE(NPOIN)
...
!
     ...
     &  NELEM2,NELMAX2,IKLE2,SURDET2,INILOC)
          USE BIEF_DEF
          IMPLICIT NONE
          INTEGER, INTENT(IN)    :: NPOIN2,NPLAN,NPLINT,NOMB
...
!    *(IKLE,IKLBOR,ELTSEG,NBOR,NELBOR,NULONE,IELM,NELEM,NELMAX,NPOIN,NPTFR)
!     IMPLICIT NONE
!     INTEGER, INTENT(IN)    :: NELEM,NELMAX,IELM,NPOIN,NPTFR
!     INTEGER, INTENT(IN)    :: ELTSEG(NELMAX,3)
!     INTEGER, INTENT(IN)    :: NULONE(NPTFR),NELBOR(NPTFR)
...
!
     ...
     &  SHPFLO , DEBFLO , FINFLO , ELTFLO , NFLOT , NITFLO,FLOPRD,
     &  MESH)
      USE BIEF_DEF
      IMPLICIT NONE

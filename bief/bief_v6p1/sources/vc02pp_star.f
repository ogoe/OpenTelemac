...
C
C***********************************************************************
C BIEF VERSION 6.1        23/11/2010  J-M HERVOUET (LNHE) 01 30 87 80 18
C                                       
C***********************************************************************
C
C FONCTION : COMPUTATION OF PARTS OF THE VECTOR
C
C                 /             --->      --->
C     V  = XMUL  /   DELTA(Z) * GRAD(U) * GRAD(PSI I)   D(OMEGA*)
C      I        /OMEGA*                           
C
C     IN THE TRANSFORMED MESH, FOR PRISMS
C
C     THE RESULTS IS GIVEN IN W IN A NON ASSEMBLED FORM
C
C     THIS VECTOR CORRESPONDS TO MATRIX: 'MATDIF*  1 3    '   (HOR)
C                             OR MATRIX: 'MATDIF*   2 4   '   (VER)
C
C
C-----------------------------------------------------------------------
C                             ARGUMENTS
...
C
      ...
      DOUBLE PRECISION XS06,X1,X2,X3,Y1,Y2,Y3,H1,H2,H3,SOMVX,SOMVY,AUX

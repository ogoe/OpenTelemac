...
!>  <br><table>
!>     <tr><th> Argument(s)
!>    </th><td> F, IKLE1, IKLE2, IKLE3, NBOR, NELEM, NELMAX, SF, W1, W2, W3, X, XMUL, Y, Z
!>   </td></tr>
!>     <tr><th> Common(s)
!>    </th><td>
!> INFO : LNG, LU
!>   </td></tr>
!>     <tr><th> Internal(s)
!>    </th><td> COEF, F1, F123, F2, F3, I1, I2, I3, IELEM, IELMF, S, X1, X2, X3, XSUR12, Y1, Y2, Y3, Z1, Z2, Z3
!>   </td></tr>
!>     <tr><th> Alias(es)
!>    </th><td> EX_VC01FT
!>   </td></tr>
...
C-----------------------------------------------------------------------
C
C     NOTE: FOR A PLANE TRIANGLE (VC01AA):
C
C     XSUR12 = XMUL / 12.D0
C

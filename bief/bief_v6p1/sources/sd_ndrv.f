...
!>  @note
!><br>     TO CONVERT THESE ROUTINES FOR DOUBLE PRECISION ARRAYS, SIMPLY USE
!><br>     THE DOUBLE PRECISION DECLARATIONS IN PLACE OF THE REAL DECLARATIONS
!><br>     IN EACH SUBPROGRAM;  IN ADDITION, THE DATA VALUE OF THE INTEGER
!><br>     VARIABLE LRATIO MUST BE SET AS INDICATED IN SUBROUTINE NDRV.
...
!>  <br><table>
!>     <tr><th> Argument(s)
!>    </th><td> A, B, C, ESP, FLAG, IA, IC, ISP, JA, N, NSP, PATH, R, RSP, Z
!>   </td></tr>
!>     <tr><th> Common(s)
!>    </th><td>
!> INFO : LNG, LU
!>   </td></tr>
!>     <tr><th> Internal(s)
!>    </th><td> D, IL, IM, IU, J, JL, JLMAX, JU, JUMAX, JUTMP, L, LMAX, LRATIO, Q, ROW, TMP, U, UMAX, VMAX
!>   </td></tr>
!>     </table>
...
!>  <br><table>
!>     <tr><th> Known(s)
!>    </th><td> SD_NNF(), SD_NNS(), SD_NNT(), SD_NSF()
!>   </td></tr>
!>     </table>
...
C  ******  INITIALISES AND DIVIDES UP TEMPORARY STORAGE  ***************
      IL = 1
      IU = IL + N+1
      JL = IU + N+1
C
C  ******  CALLS NSF IF FLAG IS SET  ***********************************

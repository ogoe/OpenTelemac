...
!
!***********************************************************************
! BIEF RELEASE 5.9       28/04/93     J-M JANIN    (LNH)     30 87 72 84
!                        12/10/05     J-M HERVOUET (LNHE) 01 30 87 80 18
!
! 08/11/2004 : ADAPTED TO THE GENERALISED SIGMA TRANSFORM
! 12/10/2005 : CORRECTED A BUG (SEE VARIABLE IELE, WHICH WAS PREVIOUSLY
...
!<<<<
     ...
     &                       / (ZSTAR(IET+1)-ZSTAR(IET))
                  ELT(IPLOT) = - SENS * ELT(IPLOT)
!
!                 CAN ONLY HAPPEN IN PARALLEL MODE ACTUALLY, NOT REQUIRED
...
!
!***********************************************************************
! BIEF RELEASE 5.9           24/04/97    J-M JANIN (LNH) 30 87 72 84
!
!***********************************************************************
!
!  FUNCTION :
...
!     FUNCTION:
!
!     SOLVES THE ADVECTION EQUATIONS USING THE CHARACTERISTIC METHOD,
!     FOR A SET OF FUNCTIONS
!
!     BEWARE: COMPATIBILITY WITH 3.0 IS NO LONGER ENSURED BECAUSE OF
!     CALL TO PARCOM
!
!     U AND UTILD CAN NOW BE VECTORS, IN WHICH CASE NOMB WILL BE
!     EQUAL TO 1
!
...
!
      IF(IELM==11) THEN
!
!       ARE THERE ANY QUADRATIC ELEMENTS ?
!
        IF(U%TYPE.EQ.4) THEN
...
!
          IF(U%ELM.EQ.13) THEN
!           INTERPOLATES THE VELOCITIES FOR A QUADRATIC VARIABLE
            CALL INTERP(U%R,UTILD%R,SHP,NDP,SHZ,ETA,ELT,
     &                  U%DIM1,U%DIM1,NPLAN,13,IKLE,NELMAX)
          ELSE
!           INTERPOLATES THE VELOCITIES FOR OTHER CASES
            CALL INTERP(U%R,UTILD%R,SHP,NDP,SHZ,ETA,ELT,

...
!>  <br><table>
!>     <tr><th> Argument(s)
!>    </th><td> IKLE1, IKLE2, IKLE3, NELEM, NELMAX, SURFAC, SW, W, W1, W2, W3, XMUL
!>   </td></tr>
!>     <tr><th> Common(s)
!>    </th><td>
!> INFO : LNG, LU
!>   </td></tr>
!>     <tr><th> Internal(s)
!>    </th><td> A, IELEM, IELMW, N1, N2, N3, WT, XSUR12
!>   </td></tr>
!>     <tr><th> Alias(es)
!>    </th><td> EX_VC05AA
!>   </td></tr>
...
C-----------------------------------------------------------------------
C
C     STRUCTURES OF W AND REAL DATA
C

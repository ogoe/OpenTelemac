...
!>  @brief       INTERFACES OF BIEF PUBLIC SUBROUTINES<br>
...
C
     ...
     &                    EQUA,NPLAN,NPMAX,NPTFRX,NELMAX,I3,I4)
        ...
        END SUBROUTINE
C
C       SUBROUTINE AS3_1111_Q
C    *(XM,NSEG1,XMT,NELMAX,NELEM,ELTSEG1,ELTSEG2,ELTSEG3,
C    *                           ORISEG1,ORISEG2,ORISEG3)
C     IMPLICIT NONE
C     INTEGER         , INTENT(IN)    :: NELMAX,NELEM,NSEG1
C     INTEGER         , INTENT(IN)    :: ELTSEG1(NELMAX)
C     INTEGER         , INTENT(IN)    :: ELTSEG2(NELMAX)
C     INTEGER         , INTENT(IN)    :: ELTSEG3(NELMAX)
C     INTEGER         , INTENT(IN)    :: ORISEG1(NELMAX)
C     INTEGER         , INTENT(IN)    :: ORISEG2(NELMAX)
C     INTEGER         , INTENT(IN)    :: ORISEG3(NELMAX)
C     DOUBLE PRECISION, INTENT(INOUT) :: XMT(NELMAX,*)
C     DOUBLE PRECISION, INTENT(INOUT) :: XM(NSEG1,2)
C       END SUBROUTINE
C
C       SUBROUTINE AS3_1111_S
C    *(XM,NSEG1,XMT,NELMAX,NELEM,ELTSEG1,ELTSEG2,ELTSEG3)
C     IMPLICIT NONE
C     INTEGER         , INTENT(IN)    :: NELMAX,NELEM,NSEG1
C     INTEGER         , INTENT(IN)    :: ELTSEG1(NELMAX)
...
C     INTEGER         , INTENT(IN)    :: ELTSEG3(NELMAX)
C     DOUBLE PRECISION, INTENT(INOUT) :: XMT(NELMAX,*)
C     DOUBLE PRECISION, INTENT(INOUT) :: XM(NSEG1)
C       END SUBROUTINE
C
C       SUBROUTINE AS3_1112
C    *(XM,NSEG11,NSEG12,XMT,NELMAX,NELEM,ELTSEG1,ELTSEG2,ELTSEG3,
C    *                                   ELTSEG4,ELTSEG5,ELTSEG6,
C    *                                   ORISEG1,ORISEG2,ORISEG3)
C     IMPLICIT NONE
C     INTEGER         , INTENT(IN)    :: NELMAX,NELEM,NSEG11,NSEG12
C     INTEGER         , INTENT(IN)    :: ELTSEG1(NELMAX)
C     INTEGER         , INTENT(IN)    :: ELTSEG2(NELMAX)
C     INTEGER         , INTENT(IN)    :: ELTSEG3(NELMAX)
C     INTEGER         , INTENT(IN)    :: ELTSEG4(NELMAX)
C     INTEGER         , INTENT(IN)    :: ELTSEG5(NELMAX)
C     INTEGER         , INTENT(IN)    :: ELTSEG6(NELMAX)
C     INTEGER         , INTENT(IN)    :: ORISEG1(NELMAX)
C     INTEGER         , INTENT(IN)    :: ORISEG2(NELMAX)
C     INTEGER         , INTENT(IN)    :: ORISEG3(NELMAX)
C     DOUBLE PRECISION, INTENT(IN)    :: XMT(NELMAX,*)
C     DOUBLE PRECISION, INTENT(INOUT) :: XM(NSEG11+NSEG12)
C       END SUBROUTINE
C
C       SUBROUTINE AS3_1211
C    *(XM,NSEG11,NSEG12,XMT,NELMAX,NELEM,ELTSEG1,ELTSEG2,ELTSEG3,
C    *                                   ELTSEG4,ELTSEG5,ELTSEG6,
C    *                                   ORISEG1,ORISEG2,ORISEG3)
C     IMPLICIT NONE
...
C     INTEGER         , INTENT(IN)    :: ORISEG3(NELMAX)
C     DOUBLE PRECISION, INTENT(IN)    :: XMT(NELMAX,*)
C     DOUBLE PRECISION, INTENT(INOUT) :: XM(NSEG12*2)
C       END SUBROUTINE
C
C       SUBROUTINE AS3_1212_S
C    *(XM,NSEG11,NSEG12,XMT,NELMAX,NELEM,ELTSEG1,ELTSEG2,ELTSEG3,
C    *                                   ELTSEG4,ELTSEG5,ELTSEG6)
C     IMPLICIT NONE
C     INTEGER         , INTENT(IN)    :: NELMAX,NELEM,NSEG11,NSEG12
...
C     INTEGER         , INTENT(IN)    :: ELTSEG6(NELMAX)
C     DOUBLE PRECISION, INTENT(INOUT) :: XMT(NELMAX,*)
C     DOUBLE PRECISION, INTENT(INOUT) :: XM(NSEG12)
C       END SUBROUTINE
C
C       SUBROUTINE AS3_4141_Q
C    *(XM,NSEG1,XMT,DIM1XMT,DIM2XMT,STOXMT,
C    * NELMAX,NELEM,ELTSEG,ORISEG)
C     IMPLICIT NONE
C     INTEGER         , INTENT(IN)    :: NELMAX,NELEM,NSEG1
C     INTEGER         , INTENT(IN)    :: DIM1XMT,DIM2XMT,STOXMT
C     INTEGER         , INTENT(IN)    :: ELTSEG(NELMAX,15)
C     INTEGER         , INTENT(IN)    :: ORISEG(NELMAX,15)
C     DOUBLE PRECISION, INTENT(IN)    :: XMT(DIM1XMT,DIM2XMT)
C     DOUBLE PRECISION, INTENT(INOUT) :: XM(NSEG1,2)
C       END SUBROUTINE
C
C       SUBROUTINE AS3_4141_S(XM,NSEG1,XMT,NELMAX,NELEM,ELTSEG)
C     IMPLICIT NONE
C     INTEGER         , INTENT(IN)    :: NELMAX,NELEM,NSEG1
C     INTEGER         , INTENT(IN)    :: DIM1XMT,DIM2XMT,STOXMT
C     INTEGER         , INTENT(IN)    :: ELTSEG(NELMAX,15)
...
C
        ...
        END SUBROUTINE
C
C       SUBROUTINE AUTORI(INDAUT,VERAUT,CODE,OPT)
C     IMPLICIT NONE
C     INTEGER, INTENT(INOUT)       :: INDAUT,VERAUT
C     INTEGER, INTENT(IN)          :: OPT
C     CHARACTER(LEN=3), INTENT(IN) :: CODE
C       END SUBROUTINE
C
...
C
     ...
     &   LV , MSK , MASKEL , MESH , FAC , TEST , STEST,INITLOC)
      ...
      TYPE(BIEF_OBJ)  , INTENT(INOUT) :: T1,T2
        END SUBROUTINE
C
C       SUBROUTINE CFLP11(U,V,X,Y,IKLE,NELEM,NELMAX,W1)
C         IMPLICIT NONE
C         INTEGER         , INTENT(IN)  :: NELEM,NELMAX
C         DOUBLE PRECISION, INTENT(IN)  :: U(*),V(*)
C         DOUBLE PRECISION, INTENT(IN)  :: X(NELMAX,*),Y(NELMAX,*)
C         INTEGER         , INTENT(IN)  :: IKLE(NELMAX,*)
C         DOUBLE PRECISION, INTENT(OUT) :: W1(NELMAX,*)
C       END SUBROUTINE
C
C       SUBROUTINE CFLP12(U,V,X,Y,IKLE,NELEM,NELMAX,W1)
C         IMPLICIT NONE
C         INTEGER         , INTENT(IN)  :: NELEM,NELMAX
C         DOUBLE PRECISION, INTENT(IN)  :: U(*),V(*)
C         DOUBLE PRECISION, INTENT(IN)  :: X(NELMAX,*),Y(NELMAX,*)
...
!
C     JMH 13/02/2008 :
C     HP COMPILER ONLY ACCEPTS A LIMITED NUMBER OF SUBROUTINES
C     I WON'T INCLUDE THESE FOR NOW
!
!
C       SUBROUTINE CG1112(X,DIM1,DIM2,IKLE,NELEM,NELMAX)
C         IMPLICIT NONE
C         INTEGER         , INTENT(IN)    :: NELEM,NELMAX,DIM1,DIM2
C         DOUBLE PRECISION, INTENT(INOUT) :: X(DIM1,DIM2)
C         INTEGER         , INTENT(IN)    :: IKLE(NELMAX,4)
C       END SUBROUTINE
!
C
!
C       SUBROUTINE CG1113(X,DIM1,DIM2,IKLE,NELEM,NELMAX)
C     IMPLICIT NONE
C     INTEGER         , INTENT(IN)    :: NELEM,NELMAX,DIM1,DIM2
C     DOUBLE PRECISION, INTENT(INOUT) :: X(DIM1,DIM2)
C     INTEGER         , INTENT(IN)    :: IKLE(NELMAX,6)
C       END SUBROUTINE
!
C
...
C
     ...
     & GLOSEG,DIMGLO,KNOLG,NPOIN)
      ...
      INTEGER, INTENT(IN)    :: KNOLG(*)
        END SUBROUTINE
!
C       SUBROUTINE COMP_IKLE
C    *(IKLE,IKLBOR,ELTSEG,NBOR,IELM,NELEM,NELMAX,NPOIN,NPTFR)
C     IMPLICIT NONE
C     INTEGER, INTENT(IN)    :: NELEM,NELMAX,IELM,NPOIN,NPTFR
C     INTEGER, INTENT(IN)    :: ELTSEG(NELMAX,3)
C     INTEGER, INTENT(INOUT) :: IKLE(NELMAX,*),IKLBOR(NPTFR,*),NBOR(*)
C       END SUBROUTINE
!
C
        SUBROUTINE COMP_SEG
...
C
        ...
        END SUBROUTINE
C
C       SUBROUTINE CPIK12(IKLE,NELEM,NELMAX,NPOIN)
C         IMPLICIT NONE
C         INTEGER, INTENT(IN)    :: NELEM,NELMAX,NPOIN
C         INTEGER, INTENT(INOUT) :: IKLE(NELMAX,4)
C       END SUBROUTINE
C
C       SUBROUTINE CPIK13
C    *(IKLE,IKLBOR,ELTSEG,NBOR,NELEM,NELMAX,NPOIN,NPTFR)
C     IMPLICIT NONE
C     INTEGER, INTENT(IN)    :: NELEM,NELMAX,NPOIN,NPTFR
C     INTEGER, INTENT(IN)    :: ELTSEG(NELMAX,3)
C     INTEGER, INTENT(INOUT) :: IKLE(NELMAX,6),IKLBOR(NPTFR,*),NBOR(*)
C       END SUBROUTINE
C
C       SUBROUTINE CPIKLE2
C    *(IKLE3,KLEI3,IKLES,NELEM2,NELMAX2,NPOIN2,NPLAN)
C     IMPLICIT NONE
C     INTEGER, INTENT(IN)    :: NELEM2,NELMAX2,NPOIN2,NPLAN
C     INTEGER, INTENT(INOUT) :: IKLES(3,NELEM2)
C     INTEGER, INTENT(INOUT) :: IKLE3(NELMAX2,NPLAN-1,6)
C     INTEGER, INTENT(INOUT) :: KLEI3(6,NELMAX2,NPLAN-1)
C       END SUBROUTINE
C
C       SUBROUTINE CPIKLE3
C    *(IKLE3,IKLES,NELEM2,NELMAX2,NPOIN2,NPLAN)
C     IMPLICIT NONE
C     INTEGER, INTENT(IN)    :: NELEM2,NELMAX2,NPOIN2,NPLAN
C     INTEGER, INTENT(INOUT) :: IKLES(3,NELEM2)
C     INTEGER, INTENT(INOUT) :: IKLE3(NELMAX2,3,NPLAN-1,4)
C       END SUBROUTINE
C
...
C
!
C       SUBROUTINE CROSFR(X,Y,XR,YR,XMAIL,YMAIL,NPMAX,NBOR,KP1BOR,
C    *                    NPTFR,DM,OK)
C         IMPLICIT NONE
C         DOUBLE PRECISION, INTENT(IN) :: X,Y,XR,YR,DM
C         INTEGER, INTENT(IN)          :: NPTFR,NPMAX
C         DOUBLE PRECISION, INTENT(IN) :: XMAIL(NPMAX),YMAIL(NPMAX)
C         INTEGER, INTENT(IN)          :: NBOR(NPTFR),KP1BOR(NPTFR)
C         LOGICAL, INTENT(INOUT)       :: OK
C       END SUBROUTINE
!
C
...
!
C       SUBROUTINE DERLAG
C    *( U , V , DT , X , Y , IKLE , IFABOR , LT , IELM , NDP , NPOIN ,
C    *  NELEM , NELMAX , SURDET , XLAG , YLAG , DX , DY ,
C    *  NSP , SHPLAG , DEBLAG , FINLAG , ELTLAG , NLAG , RESUX , RESUY ,
C    *  NBOR , NELBOR , NULONE , NPTFR , MSK,MASKEL,MASKPT,T8)
C     IMPLICIT NONE
C     INTEGER         , INTENT(IN)    :: NPOIN,LT,IELM,NDP,NELEM,NLAG
C     INTEGER         , INTENT(IN)    :: NPTFR,NELMAX
C     DOUBLE PRECISION, INTENT(IN)    :: U(NPOIN),V(NPOIN),DT
C     DOUBLE PRECISION, INTENT(IN)    :: X(NPOIN),Y(NPOIN)
C     INTEGER         , INTENT(IN)    :: IKLE(NELMAX,NDP)
C     INTEGER         , INTENT(IN)    :: IFABOR(NELMAX,NDP)
C     DOUBLE PRECISION, INTENT(IN)    :: SURDET(NELEM)
C     DOUBLE PRECISION, INTENT(INOUT) :: XLAG(NPOIN,NLAG)
C     DOUBLE PRECISION, INTENT(INOUT) :: YLAG(NPOIN,NLAG)
C     INTEGER         , INTENT(INOUT) :: DEBLAG(NLAG),FINLAG(NLAG)
C     INTEGER         , INTENT(INOUT) :: ELTLAG(NPOIN,NLAG)
C     DOUBLE PRECISION, INTENT(INOUT) :: T8(NPOIN)
C     DOUBLE PRECISION, INTENT(INOUT) :: DX(NPOIN),DY(NPOIN)
C     INTEGER         , INTENT(INOUT) :: NSP(NPOIN)
C     DOUBLE PRECISION, INTENT(INOUT) :: RESUX(NPOIN),RESUY(NPOIN)
C     DOUBLE PRECISION, INTENT(INOUT) :: SHPLAG(NDP,NPOIN,NLAG)
C     INTEGER         , INTENT(IN)    :: NBOR(NPTFR),NELBOR(NPTFR)
C     INTEGER         , INTENT(IN)    :: NULONE(NPTFR)
C     LOGICAL         , INTENT(IN)    :: MSK
C     DOUBLE PRECISION, INTENT(IN)    :: MASKEL(NELMAX),MASKPT(NPOIN)
C       END SUBROUTINE
!
C
        SUBROUTINE DES11
...
C
C       SUBROUTINE VC11BB
C    *( XMUL,SF,SG,F,G,XEL,YEL,
C    *  IKLE1,IKLE2,IKLE3,IKLE4,NELEM,NELMAX,W1,W2,W3,W4 , ICOORD )
C     USE BIEF_DEF
C     IMPLICIT NONE
C     INTEGER, INTENT(IN) :: NELEM,NELMAX,ICOORD
C     INTEGER, INTENT(IN) :: IKLE1(NELMAX),IKLE2(NELMAX)
C     INTEGER, INTENT(IN) :: IKLE3(NELMAX),IKLE4(NELMAX)
C     DOUBLE PRECISION, INTENT(IN)    :: XEL(NELMAX,*),YEL(NELMAX,*)
C     DOUBLE PRECISION, INTENT(INOUT) :: W1(NELMAX),W2(NELMAX)
C     DOUBLE PRECISION, INTENT(INOUT) :: W3(NELMAX),W4(NELMAX)
C     DOUBLE PRECISION, INTENT(IN)    :: XMUL
C     TYPE(BIEF_OBJ), INTENT(IN)   :: SF,SG
C     DOUBLE PRECISION, INTENT(IN) :: F(*),G(*)
C       END SUBROUTINE
C
C       SUBROUTINE VC11PP
C    *( XMUL,SF,SG,F,G,X,Y,Z,
C    *  IKLE1,IKLE2,IKLE3,IKLE4,IKLE5,IKLE6,NELEM,NELMAX,
C    *  W1,W2,W3,W4,W5,W6 , ICOORD )
C     USE BIEF_DEF
C     IMPLICIT NONE
C     INTEGER, INTENT(IN) :: NELEM,NELMAX,ICOORD
C     INTEGER, INTENT(IN) :: IKLE1(NELMAX),IKLE2(NELMAX),IKLE3(NELMAX)
C     INTEGER, INTENT(IN) :: IKLE4(NELMAX),IKLE5(NELMAX),IKLE6(NELMAX)
C     DOUBLE PRECISION, INTENT(IN)   ::X(*),Y(*),Z(*),XMUL
C     DOUBLE PRECISION, INTENT(INOUT)::W1(NELMAX),W2(NELMAX),W3(NELMAX)
C     DOUBLE PRECISION, INTENT(INOUT)::W4(NELMAX),W5(NELMAX),W6(NELMAX)
C     TYPE(BIEF_OBJ) :: SF,SG
...
C       SUBROUTINE VC13AA
C    *( XMUL,SF,F,XEL,YEL,
C    *  IKLE1,IKLE2,IKLE3,IKLE4,NELEM,NELMAX,W1,W2,W3 , ICOORD )
C     USE BIEF_DEF
C     IMPLICIT NONE
C     INTEGER, INTENT(IN) :: NELEM,NELMAX,ICOORD
C     INTEGER, INTENT(IN) :: IKLE1(NELMAX),IKLE2(NELMAX)
...
C     DOUBLE PRECISION, INTENT(INOUT) ::W1(NELMAX),W2(NELMAX),W3(NELMAX)
C     DOUBLE PRECISION, INTENT(IN)    :: XMUL
C     TYPE(BIEF_OBJ), INTENT(IN) :: SF
C     DOUBLE PRECISION, INTENT(IN) :: F(*)
C       END SUBROUTINE
C
C       SUBROUTINE VC13BB
C    *( XMUL,SF,F,XEL,YEL,
C    *  IKLE1,IKLE2,IKLE3,IKLE4,NELEM,NELMAX,
C    *  W1,W2,W3,W4,ICOORD )
C     USE BIEF_DEF
C     IMPLICIT NONE
C     INTEGER, INTENT(IN) :: NELEM,NELMAX,ICOORD
C     INTEGER, INTENT(IN) :: IKLE1(NELMAX),IKLE2(NELMAX)
...
C       SUBROUTINE VC13CC
C    *( XMUL,SF,F,XEL,YEL,
C    *  IKLE1,IKLE2,IKLE3,IKLE4,IKLE5,IKLE6,
C    *  NELEM,NELMAX,
C    *  W1,W2,W3,W4,W5,W6,ICOORD )
C     USE BIEF_DEF
C     IMPLICIT NONE
...
C     DOUBLE PRECISION, INTENT(INOUT) :: W1(NELMAX),W2(NELMAX)
C     DOUBLE PRECISION, INTENT(INOUT) :: W3(NELMAX),W4(NELMAX)
C     DOUBLE PRECISION, INTENT(INOUT) :: W5(NELMAX),W6(NELMAX)
C     DOUBLE PRECISION, INTENT(IN)    :: XMUL
C     TYPE(BIEF_OBJ), INTENT(IN) :: SF
C     DOUBLE PRECISION, INTENT(IN) :: F(*)
C       END SUBROUTINE
C
C       SUBROUTINE VC13PP2
C    *( XMUL,SF,F,X,Y,Z,
C    *  IKLE1,IKLE2,IKLE3,IKLE4,IKLE5,IKLE6,NELEM,NELMAX,
C    *  W1,W2,W3,W4,W5,W6,ICOORD)
C     USE BIEF_DEF
...
C     INTEGER, INTENT(IN) :: IKLE1(NELMAX),IKLE2(NELMAX),IKLE3(NELMAX)
C     INTEGER, INTENT(IN) :: IKLE4(NELMAX),IKLE5(NELMAX),IKLE6(NELMAX)
C     DOUBLE PRECISION, INTENT(IN)    :: X(*),Y(*),Z(*)
C     DOUBLE PRECISION, INTENT(INOUT) ::W1(NELMAX),W2(NELMAX),W3(NELMAX)
C     DOUBLE PRECISION, INTENT(INOUT) ::W4(NELMAX),W5(NELMAX),W6(NELMAX)
C     DOUBLE PRECISION, INTENT(IN)    :: XMUL
C     TYPE(BIEF_OBJ), INTENT(IN)      :: SF
...
C    *( XMUL,SF,F,X,Y,Z,
C    *  IKLE1,IKLE2,IKLE3,IKLE4,IKLE5,IKLE6,NELEM,NELMAX,
C    *  W1,W2,W3,W4,W5,W6 , ICOORD , FORMUL )
C     USE BIEF_DEF
C     IMPLICIT NONE
C     INTEGER, INTENT(IN) :: NELEM,NELMAX,ICOORD
C     INTEGER, INTENT(IN) :: IKLE1(NELMAX),IKLE2(NELMAX),IKLE3(NELMAX)
...
C     TYPE(BIEF_OBJ), INTENT(IN) :: SF
C     DOUBLE PRECISION, INTENT(IN) :: F(*)
C     CHARACTER(LEN=16), INTENT(IN) :: FORMUL
C       END SUBROUTINE
C
C       SUBROUTINE VC13TT
C    *( XMUL,SF,F,X,Y,Z,
C    *  IKLE1,IKLE2,IKLE3,IKLE4,NELEM,NELMAX,
C    *  W1,W2,W3,W4,ICOORD , FORMUL )
C     USE BIEF_DEF
C     IMPLICIT NONE
C     INTEGER, INTENT(IN) :: NELEM,NELMAX,ICOORD
C     INTEGER, INTENT(IN) :: IKLE1(NELMAX),IKLE2(NELMAX)
...
C
C       SUBROUTINE VC14AA
C    *( XMUL,SU,SV,U,V,XEL,YEL,SURFAC,IKLE1,IKLE2,IKLE3,NELEM,NELMAX,
C    *  W1,W2,W3)
C     USE BIEF_DEF
C     IMPLICIT NONE
C     INTEGER, INTENT(IN) :: NELEM,NELMAX
...
C     DOUBLE PRECISION, INTENT(IN) :: XEL(NELMAX,*),YEL(NELMAX,*)
C     DOUBLE PRECISION, INTENT(INOUT) ::W1(NELMAX),W2(NELMAX),W3(NELMAX)
C     DOUBLE PRECISION, INTENT(IN) :: SURFAC(NELMAX)
C     DOUBLE PRECISION, INTENT(IN) :: XMUL
C     TYPE(BIEF_OBJ), INTENT(IN) :: SU,SV
C     DOUBLE PRECISION, INTENT(IN) :: U(*),V(*)
C       END SUBROUTINE
C
C       SUBROUTINE VC15AA
C    *( XMUL,SF,SU,SV,F,U,V,
C    *  XEL,YEL,
C    *  IKLE1,IKLE2,IKLE3,IKLE4,NELEM,NELMAX,
C    *  W1,W2,W3)
C     USE BIEF_DEF
...
C     DOUBLE PRECISION, INTENT(INOUT) ::W1(NELMAX),W2(NELMAX),W3(NELMAX)
C     DOUBLE PRECISION, INTENT(IN) :: XMUL
C     TYPE(BIEF_OBJ), INTENT(IN) :: SF,SU,SV
C     DOUBLE PRECISION, INTENT(IN) :: F(*),U(*),V(*)
C       END SUBROUTINE
C
C       SUBROUTINE VC16AA
C    *( XMUL,SF,SG,SU,SV,F,G,U,V,
C    *  XEL,YEL,SURFAC,
C    *  IKLE1,IKLE2,IKLE3,NELEM,NELMAX,
C    *  W1,W2,W3 )
C     USE BIEF_DEF
C     IMPLICIT NONE
C     INTEGER, INTENT(IN) :: NELEM,NELMAX
...
C     DOUBLE PRECISION, INTENT(IN) :: SURFAC(NELMAX)
C     DOUBLE PRECISION, INTENT(IN) :: XMUL
C     TYPE(BIEF_OBJ), INTENT(IN) :: SF,SG,SU,SV
C     DOUBLE PRECISION, INTENT(IN) :: F(*),G(*),U(*),V(*)
C       END SUBROUTINE
C
C       SUBROUTINE VC18PP
C    *( XMUL,SF,SU,SV,F,U,V,X,Y,Z,
C    *  IKLE1,IKLE2,IKLE3,IKLE4,IKLE5,IKLE6,NELEM,NELMAX,
C    *  W1,W2,W3)
C     USE BIEF_DEF
C     IMPLICIT NONE
...
C
C       SUBROUTINE VC19AA
C    *( XMUL,SF,SG,SH,SU,SV,F,G,H,U,V,
C    *  XEL,YEL,SURFAC,IKLE1,IKLE2,IKLE3,NELEM,NELMAX,W1,W2,W3,FORMUL)
C     USE BIEF_DEF
C     IMPLICIT NONE
C     INTEGER, INTENT(IN) :: NELEM,NELMAX
C     INTEGER, INTENT(IN) :: IKLE1(NELMAX),IKLE2(NELMAX),IKLE3(NELMAX)
...
C     DOUBLE PRECISION, INTENT(IN)    :: XEL(NELMAX,*),YEL(NELMAX,*)
C     DOUBLE PRECISION, INTENT(IN)    :: SURFAC(NELMAX)
C     DOUBLE PRECISION, INTENT(INOUT) :: W1(*),W2(*),W3(*)
C     TYPE(BIEF_OBJ), INTENT(IN)    :: SF,SH,SG,SU,SV
C     DOUBLE PRECISION, INTENT(IN)  :: F(*),G(*),H(NELMAX,3),U(*),V(*)
C     CHARACTER(LEN=16), INTENT(IN) :: FORMUL
C       END SUBROUTINE
C
C       SUBROUTINE VECLE3(LV,IKLE,NELEM,NELMAX,NPOIN,V)
C     USE BIEF_DEF
C     IMPLICIT NONE
C     INTEGER, INTENT(INOUT)          :: LV
C     INTEGER, INTENT(IN)             :: NELEM,NELMAX,NPOIN
C     INTEGER, INTENT(IN)             :: IKLE(NELMAX,3)
C     DOUBLE PRECISION, INTENT(INOUT) :: V(NPOIN)
C       END SUBROUTINE
C
C       SUBROUTINE VECLE4(LV,IKLE,NELEM,NELMAX,NPOIN,V)
C     USE BIEF_DEF
C     IMPLICIT NONE
C     INTEGER, INTENT(INOUT) :: LV
C     INTEGER, INTENT(IN)    :: NELEM,NELMAX,NPOIN
...
C       END SUBROUTINE
C
C       SUBROUTINE VECLE6(LV,IKLE,NELEM,NELMAX,NPOIN,V)
C     USE BIEF_DEF
C     IMPLICIT NONE
C     INTEGER, INTENT(INOUT) :: LV
C     INTEGER, INTENT(IN)    :: NELEM,NELMAX,NPOIN
...
C       END SUBROUTINE
C
C       SUBROUTINE VECLEN(LV,NDP,IKLE,NELEM,NELMAX,NPOIN,V)
C     USE BIEF_DEF
C     IMPLICIT NONE
C     INTEGER, INTENT(INOUT) :: LV
C     INTEGER, INTENT(IN)    :: NELEM,NELMAX,NDP,NPOIN
C     INTEGER, INTENT(IN)    :: IKLE(NELMAX,NDP)
C     DOUBLE PRECISION, INTENT(INOUT) :: V(NPOIN)
C       END SUBROUTINE
C
...
C       SUBROUTINE VECTOS
C    *(VEC,OP,FORMUL,
C    * XMUL,F,G,H,U,V,W,SF,SG,SH,SU,SV,SW,
C    * T,LEGO,
C    * XEL,YEL,ZEL, SURFAC,IKLE,NBOR,
C    * XNOR,YNOR,ZNOR,NPT,NELEM,NELMAX,IELM1,LV,MSK,MASKEL,MESH)
C     USE BIEF_DEF
C     IMPLICIT NONE
C     INTEGER, INTENT(IN) :: NELMAX,NPT,NELEM,IELM1,LV
C     INTEGER, INTENT(IN) :: IKLE(NELMAX,*),NBOR(*)
C     DOUBLE PRECISION, INTENT(IN)    :: SURFAC(NELMAX)
C     DOUBLE PRECISION, INTENT(IN)    :: XEL(*),YEL(*),ZEL(*)
C     DOUBLE PRECISION, INTENT(IN)    :: XNOR(*),YNOR(*),ZNOR(*)
C     DOUBLE PRECISION, INTENT(INOUT) :: T(NELMAX,*),VEC(*)
C     DOUBLE PRECISION, INTENT(IN)    :: XMUL,MASKEL(NELMAX)
C     DOUBLE PRECISION, INTENT(IN) :: F(*),G(*),H(*),U(*),V(*),W(*)
C     TYPE(BIEF_OBJ), INTENT(IN)      :: SF,SG,SH,SU,SV,SW
C     TYPE(BIEF_MESH), INTENT(INOUT) :: MESH
C     LOGICAL, INTENT(IN) :: MSK,LEGO
C     CHARACTER(LEN=16), INTENT(IN) :: FORMUL
C     CHARACTER(LEN=1), INTENT(IN) :: OP
C       END SUBROUTINE
C
C       SUBROUTINE VGFPSI
C    *  (RES,IELM,U,V,F,DT,XMUL,CFLMAX,T1,T2,MESH,MSK,MASKEL)
C         USE BIEF_DEF
C         IMPLICIT NONE
C         LOGICAL         , INTENT(IN)    :: MSK
C         DOUBLE PRECISION, INTENT(OUT)   :: CFLMAX
C         DOUBLE PRECISION, INTENT(IN)    :: DT,XMUL
C         TYPE(BIEF_OBJ)  , INTENT(INOUT) :: RES,T1,T2
C         TYPE(BIEF_OBJ)  , INTENT(IN)    :: U,V,F,MASKEL
C         TYPE(BIEF_MESH) , INTENT(INOUT) :: MESH
C         INTEGER         , INTENT(IN)    :: IELM
C       END SUBROUTINE
C
C       SUBROUTINE VOISIN
C    *(IFABOR,NELEM,NELMAX,IELM,IKLE,SIZIKL,
C    * NPOIN,NACHB,NBOR,NPTFR,IADR,NVOIS)
C     USE BIEF_DEF
C     IMPLICIT NONE
C     INTEGER, INTENT(IN) :: NPTFR,SIZIKL,NELEM,NELMAX,IELM,NPOIN
C     INTEGER, INTENT(IN) :: NBOR(NPTFR),NACHB(NBMAXNSHARE,*)
C     INTEGER, INTENT(IN) :: IKLE(SIZIKL,*)
C     INTEGER, INTENT(INOUT) :: IFABOR(NELMAX,*)
C     INTEGER, INTENT(INOUT) :: NVOIS(NPOIN),IADR(NPOIN)
C       END SUBROUTINE
C
C       SUBROUTINE VOISIN31
C    *(IFABOR,NELEM,NELMAX,IELM,IKLE,SIZIKL,
C    * NPOIN,NACHB,NBOR,NPTFR,LIHBOR,KLOG,IKLESTR,NELEMTOTAL,NELEB2)
C     USE BIEF_DEF
C     IMPLICIT NONE
C     INTEGER, INTENT(IN   ) :: IELM
C     INTEGER, INTENT(IN   ) :: NPTFR
C     INTEGER, INTENT(IN   ) :: NELEM
C     INTEGER, INTENT(IN   ) :: NELMAX
C     INTEGER, INTENT(IN   ) :: NPOIN
C     INTEGER, INTENT(IN   ) :: SIZIKL
C     INTEGER, INTENT(IN   ) :: NBOR(NPTFR)
C     INTEGER, INTENT(IN   ) :: NACHB(NBMAXNSHARE,*)
C     INTEGER, INTENT(INOUT) :: IFABOR(NELMAX,4)
C     INTEGER, INTENT(IN   ) :: IKLE(SIZIKL,4)
C     INTEGER, INTENT(IN   ) :: LIHBOR(NPTFR)
C     INTEGER, INTENT(IN   ) :: KLOG
C     INTEGER, INTENT(IN   ) :: NELEMTOTAL
C     INTEGER, INTENT(IN   ) :: IKLESTR(NELEMTOTAL,3)
C     INTEGER, INTENT(IN   ) :: NELEB2
C       END SUBROUTINE
C
      END INTERFACE
C

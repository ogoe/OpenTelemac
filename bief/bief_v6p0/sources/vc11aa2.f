...
!>  <br><table>
!>     <tr><th> Argument(s)
!>    </th><td> F, G, H, ICOORD, IKLE1, IKLE2, IKLE3, NELEM, NELMAX, SF, SG, SH, W1, W2, W3, XEL, XMUL, YEL
!>   </td></tr>
!>     <tr><th> Common(s)
!>    </th><td>
!> INFO : LNG, LU
!>   </td></tr>
!>     <tr><th> Internal(s)
!>    </th><td> F1, F2, F3, G1, G2, G3, IELEM, IELMF, IELMG, IELMH, KSAT, X2, X3, XSUR24, Y2, Y3
!>   </td></tr>
!>     <tr><th> Alias(es)
!>    </th><td> EX_VC11AA2
!>   </td></tr>
...
C-----------------------------------------------------------------------
C
C     F IS P1, G IS DISCONTINUOUS P1, H IS P0
C

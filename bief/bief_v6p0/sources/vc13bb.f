...
!>  <br><table>
!>     <tr><th> Argument(s)
!>    </th><td> F, ICOORD, IKLE1, IKLE2, IKLE3, IKLE4, NELEM, NELMAX, SF, W1, W2, W3, W4, XEL, XMUL, YEL
!>   </td></tr>
!>     <tr><th> Common(s)
!>    </th><td>
!> INFO : LNG, LU
!>   </td></tr>
!>     <tr><th> Internal(s)
!>    </th><td> DISCF, F1, F2, F3, F4, IELEM, IELMF, X2, X3, XSUR18, XSUR6, XSUR9, Y2, Y3
!>   </td></tr>
!>     </table>
...
C
C-----------------------------------------------------------------------
C     F IS QUASI-BUBBLE BUT DISCONTINUOUS BETWEEN THE ELEMENTS
C-----------------------------------------------------------------------
C

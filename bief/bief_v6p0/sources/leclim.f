...
!>  <br><table>
!>     <tr><th> Argument(s)
!>    </th><td> ATBOR, AUBOR, BOUNDARY_COLOUR, BTBOR, HBOR, KADH, KENT, KENTU, KINC, KLOG, KSORT, LIHBOR, LITBOR, LIUBOR, LIVBOR, MESH, NLIM, NPTFR, NPTFR2, NUMLIQ, STDGEO, TBOR, TRAC, UBOR, VBOR
!>   </td></tr>
!>     <tr><th> Use(s)
!>    </th><td>
!> BIEF_DEF :<br>
...
C
      DO 50 K=1,NPTFR
C
C     CANCELS FRICTION COEFFICIENT WHEN IT IS NOT USED
C

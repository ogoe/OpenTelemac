...
!><br>            THE ELEMENT IS THE P1 TRIANGLE.
!>  @code
!>            M = TETA     * MASS MATRIX
...
!>  <br><table>
!>     <tr><th> Argument(s)
!>    </th><td> A11, A12, A13, A22, A23, A33, F, NELEM, NELMAX, SF, SURFAC, XMUL
!>   </td></tr>
!>     <tr><th> Common(s)
!>    </th><td>
!> INFO : LNG, LU
...
C
      IELMF = SF%ELM
C
C  CASE WHERE F IS CONSTANT BY ELEMENT
C
      IF(IELMF.EQ.10) THEN
C
      DO 1 IELEM = 1 , NELEM

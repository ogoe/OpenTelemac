...
!>  <br><table>
!>     <tr><th> Argument(s)
!>    </th><td> IKLE1, IKLE2, IKLE3, LV, NELEM, NELMAX, NPOIN, X, XA1, XA2, XA3
!>   </td></tr>
!>     <tr><th> Common(s)
!>    </th><td>
!> INFO : LNG, LU
...
C
C~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
C| IKLE1,IKLE2,IKL|-->| PASSAGE DE LA NUMEROTATION LOCALE A GLOBALE
...
C| X             |---| 
C| XA1,XA2,XA3    |<--| TERMES EXTRADIAGONAUX DE LA MATRICE A

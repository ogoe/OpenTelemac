...
!><br>            CASE OF LINEAR-LINEAR PRISM AND NON SYMMETRICAL MATRIX.
!>  @code
...
C
C         SEGMENT 04 (TERMS 4-5 AND 5-4)
...
C
C         SEGMENT 05 (TERMS 5-6 AND 6-5)
...
C
C         SEGMENT 06 (TERMS 6-4 AND 4-6)

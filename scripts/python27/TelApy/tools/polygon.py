...
if __name__ == "__main__":
    ...
    print is_in_polygon(1.0, 1.0, MY_POLY), True
    print is_in_polygon(0.0, 0.0, MY_POLY), True
    print is_in_polygon(-1.0, 1.0, MY_POLY), False
    print is_in_polygon(2.0, 0.0, MY_POLY), True

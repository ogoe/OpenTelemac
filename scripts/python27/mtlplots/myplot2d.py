...
def drawColouredTriVects(myplt,decoUser,(x,y,uv,normalised)):
   ...
   if (decoUser.has_key('key_x')): key_x = float(decoUser['key_x'])
   if (decoUser.has_key('key_y')): key_y = float(decoUser['key_y'])
   if (decoUser.has_key('key_length')): key_length = float(decoUser['key_length'])
   if (decoUser.has_key('key_label')): key_label = decoUser['key_label']

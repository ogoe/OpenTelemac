...
!                                        
     &( xA1,yA1,xA2,yA2,  xB1,yB1,xB2,yB2,  xS,yS )
      ...
      REAL (KIND=8),INTENT(IN)  :: xA1,yA1, xA2,yA2 ! points: A1,A2
      REAL (KIND=8),INTENT(IN)  :: xB1,yB1, xB2,yB2 ! points: B1,B2
      REAL (KIND=8),INTENT(OUT) :: xS,yS            ! point:  S  (intesection)
                                                    
      REAL (KIND=8) ::  AAx, AAy, AAC ! equation coefficients   A1A2
      REAL (KIND=8) ::  BBx, BBy, BBC ! equBtion coefficients   B1B2
      REAL (KIND=8) ::  D, Dx, Dy     ! determinats
                                         
!663   FORMAT(' ?>',2(/,' ?>'))            ! 3 lines like "?>         "
      WRITE(6,*)'?>-------  SR Intersection -----------------' 

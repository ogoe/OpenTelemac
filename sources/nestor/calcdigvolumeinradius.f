...
!     INTEGER       ,INTENT(IN)    :: KNOGL(:)  ! index list: Global to Local node index
      ...
      REAL (KIND=8)        ::  x, y
      REAL (KIND=8)        ::  sqrdRadius,  sqrdDist 
      REAL (KIND=8)        ::  DigVolumeInRadius
...
!663   FORMAT(' ?>',2(/,' ?>'))            ! 3 lines like "?>         "
      WRITE(6,*)'?>-------  SR CalcDigVolumeInRadius --------'
...
!       iMesh  = KNOGL(i)  !> Convert global to local index. If "global node" is 
        ...
        ELSE                   
          x = 0.0_8                  !> The "global node" does not 
          y = 0.0_8                  !  reside in this partition
        ENDIF
...
!     |                                       serial computing         |     
     ...
     &   DEALLOCATE( DigNodeInsideRadius )
      ...
      WRITE(6,*)'?>-------  SR CalcDigVolumeInRadius END ----'
      RETURN                                           
!***                                              ********************************************
!***                                              ********************************************

...
!        PROPORTIONNALLY TO VOLUMES, SEE SUR2VOL IN MURD3D_LIPS)
!
!       L12 = XM(01,IELEM)
!       L13 = XM(02,IELEM)
!       L14 = XM(03,IELEM)
...
!
        IF(ORISEG(IELEM,1).EQ.1) THEN
          IF(FXMATPAR(ISEG1).GT.0.D0) THEN
            L12=0.D0
            L21= FXMATPAR(ISEG1)*(H1+H2)*COEF*SUR2VOL(ISEG1)
          ELSE
            L21=0.D0
            L12=-FXMATPAR(ISEG1)*(H1+H2)*COEF*SUR2VOL(ISEG1)
          ENDIF
        ELSE
          IF(FXMATPAR(ISEG1).GT.0.D0) THEN
            L21=0.D0
...
!
        IF(ORISEG(IELEM,2).EQ.1) THEN
          IF(FXMATPAR(ISEG2).GT.0.D0) THEN
            L23=0.D0
            L32= FXMATPAR(ISEG2)*(H2+H3)*COEF*SUR2VOL(ISEG2)
          ELSE
            L32=0.D0
            L23=-FXMATPAR(ISEG2)*(H2+H3)*COEF*SUR2VOL(ISEG2)
          ENDIF
        ELSE
          IF(FXMATPAR(ISEG2).GT.0.D0) THEN
            L32=0.D0
...
!
        IF(ORISEG(IELEM,3).EQ.1) THEN
          IF(FXMATPAR(ISEG3).GT.0.D0) THEN
            L31=0.D0
            L13= FXMATPAR(ISEG3)*(H1+H3)*COEF*SUR2VOL(ISEG3)
          ELSE
            L13=0.D0
            L31=-FXMATPAR(ISEG3)*(H1+H3)*COEF*SUR2VOL(ISEG3)
          ENDIF
        ELSE
          IF(FXMATPAR(ISEG3).GT.0.D0) THEN
            L13=0.D0
...
!
        IF(ORISEG(IELEM,4).EQ.1) THEN
          IF(FXMATPAR(ISEG4).GT.0.D0) THEN
            L45=0.D0
            L54= FXMATPAR(ISEG4)*(H4+H5)*COEF*SUR2VOL(ISEG4)
          ELSE
            L54=0.D0
            L45=-FXMATPAR(ISEG4)*(H4+H5)*COEF*SUR2VOL(ISEG4)
          ENDIF
        ELSE
          IF(FXMATPAR(ISEG4).GT.0.D0) THEN
            L54=0.D0
...
!
        IF(ORISEG(IELEM,5).EQ.1) THEN
          IF(FXMATPAR(ISEG5).GT.0.D0) THEN
            L56=0.D0
            L65= FXMATPAR(ISEG5)*(H5+H6)*COEF*SUR2VOL(ISEG5)
          ELSE
            L65=0.D0
            L56=-FXMATPAR(ISEG5)*(H5+H6)*COEF*SUR2VOL(ISEG5)
          ENDIF
        ELSE
          IF(FXMATPAR(ISEG5).GT.0.D0) THEN
            L65=0.D0
...
!
        IF(ORISEG(IELEM,6).EQ.1) THEN
          IF(FXMATPAR(ISEG6).GT.0.D0) THEN
            L64=0.D0
            L46= FXMATPAR(ISEG6)*(H4+H6)*COEF*SUR2VOL(ISEG6)
          ELSE
            L46=0.D0
            L64=-FXMATPAR(ISEG6)*(H4+H6)*COEF*SUR2VOL(ISEG6)
          ENDIF
        ELSE
          IF(FXMATPAR(ISEG6).GT.0.D0) THEN
            L46=0.D0
...
!
        IF(FXMATPAR(ISEG7).GT.0.D0) THEN
          L14=0.D0
          L41= FXMATPAR(ISEG7)*(H1+H4)*COEF*SUR2VOL(ISEG7)
        ELSE
          L41=0.D0
          L14=-FXMATPAR(ISEG7)*(H1+H4)*COEF*SUR2VOL(ISEG7)
        ENDIF
!
!       SEGMENT 8 (VERTICAL)
!
        IF(FXMATPAR(ISEG8).GT.0.D0) THEN
          L25=0.D0
          L52= FXMATPAR(ISEG8)*(H2+H5)*COEF*SUR2VOL(ISEG8)
        ELSE
          L52=0.D0
          L25=-FXMATPAR(ISEG8)*(H2+H5)*COEF*SUR2VOL(ISEG8)
        ENDIF
!
!       SEGMENT 9 (VERTICAL)
!
...
!         IF(L51.GT. FXMATPAR(ISEG10)) L51=FXMATPAR(ISEG10)
          L51= FXMATPAR(ISEG10)*(H1+H5)*COEF*SUR2VOL(ISEG10)
        ELSE
          L51=0.D0
!         IF(L15.GT.-FXMATPAR(ISEG10)) L15=-FXMATPAR(ISEG10)
          L15=-FXMATPAR(ISEG10)*(H1+H5)*COEF*SUR2VOL(ISEG10)
        ENDIF
!
!       SEGMENT 11
!
...
!         IF(L42.GT. FXMATPAR(ISEG11)) L42=FXMATPAR(ISEG11)
          L42= FXMATPAR(ISEG11)*(H2+H4)*COEF*SUR2VOL(ISEG11)
        ELSE
          L42=0.D0
!         IF(L24.GT.-FXMATPAR(ISEG11)) L24=-FXMATPAR(ISEG11)
          L24=-FXMATPAR(ISEG11)*(H2+H4)*COEF*SUR2VOL(ISEG11)
        ENDIF
!
!       SEGMENT 12
!
...
!         IF(L62.GT. FXMATPAR(ISEG12)) L62=FXMATPAR(ISEG12)
          L62= FXMATPAR(ISEG12)*(H2+H6)*COEF*SUR2VOL(ISEG12)
        ELSE
          L62=0.D0
!         IF(L26.GT.-FXMATPAR(ISEG12)) L26=-FXMATPAR(ISEG12)
          L26=-FXMATPAR(ISEG12)*(H2+H6)*COEF*SUR2VOL(ISEG12)
        ENDIF
!
!       SEGMENT 13
!
...
!         IF(L53.GT. FXMATPAR(ISEG13)) L53=FXMATPAR(ISEG13)
          L53= FXMATPAR(ISEG13)*(H3+H5)*COEF*SUR2VOL(ISEG13)
        ELSE
          L53=0.D0
!         IF(L35.GT.-FXMATPAR(ISEG13)) L35=-FXMATPAR(ISEG13)
          L35=-FXMATPAR(ISEG13)*(H3+H5)*COEF*SUR2VOL(ISEG13)
        ENDIF
!
!       SEGMENT 14
!
...
!         IF(L34.GT.-FXMATPAR(ISEG14)) L34=-FXMATPAR(ISEG14)
          L34=-FXMATPAR(ISEG14)*(H3+H4)*COEF*SUR2VOL(ISEG14)
        ENDIF
!
!       SEGMENT 15
!
...
!         IF(L61.GT. FXMATPAR(ISEG15)) L61=FXMATPAR(ISEG15)
          L61= FXMATPAR(ISEG15)*(H1+H6)*COEF*SUR2VOL(ISEG15)
        ELSE
          L61=0.D0
!         IF(L16.GT.-FXMATPAR(ISEG15)) L16=-FXMATPAR(ISEG15)
          L16=-FXMATPAR(ISEG15)*(H1+H6)*COEF*SUR2VOL(ISEG15)
        ENDIF
!

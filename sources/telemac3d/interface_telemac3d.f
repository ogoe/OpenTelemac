...
C
     ...
     &  AC     , KSPRATIO,ICR,ICQ,RUGOF,SETDEP,HMIN)
      USE BIEF_DEF
      IMPLICIT NONE
      INTEGER, INTENT(IN) :: NPOIN2, NPOIN3, KLOG 
...
C
     ...
     &  VOLU2D, V2DPAR, SETDEP)
      ...
      LOGICAL, INTENT(IN)             :: INCHYD,YASEM3D,RAIN
...
C
     ...
     &  NPOIN3 , NPOIN2 , NPLAN  , KLOG   , HMIN,SEDCO, SETDEP)
      IMPLICIT NONE
      ...
      DOUBLE PRECISION, INTENT(IN) :: GRADZFX(NPOIN2), GRADZFY(NPOIN2)
      DOUBLE PRECISION, INTENT(IN) :: GRADZSX(NPOIN2), GRADZSY(NPOIN2)
      DOUBLE PRECISION, INTENT(IN) :: HN(NPOIN2), HMIN
...
C
      INTERFACE
        SUBROUTINE FONVAS
     &(IVIDE  , EPAI   , CONC  , TREST  , TEMP   , HDEP  , FLUDP,
     & FLUDPT , FLUER,  ZF    , TA     , WC     , TRA01 ,
     & TRA02  , TRA03  , NPOIN2, NPOIN3 , NPFMAX , NCOUCH,
     & NPF    , LT     , DT     , DTC   , GRAV   , RHOS  ,CFMAX  , 
     &   TASSE  , ITASS, ZF_S, ESOMT,  VOLU2D, 
     & MASDEP, SETDEP)
      USE BIEF_DEF
      IMPLICIT NONE
      ...
      DOUBLE PRECISION, INTENT(INOUT) :: ZF(NPOIN2), ESOMT(NPOIN2)
      DOUBLE PRECISION, INTENT(INOUT) :: ZF_S(NPOIN2), FLUDP(NPOIN2)
      ...
      LOGICAL, INTENT(IN) :: TASSE
      INTEGER, INTENT(IN) :: ITASS,SETDEP
        END SUBROUTINE
      END INTERFACE
C
C-----------------------------------------------------------------------
...
C
      INTERFACE
        SUBROUTINE SED3D
     &(MASBED,MASBED0,MASDEP, WC,TA,EPAI,HDEP,CONC,FLUER,PDEPOT,TRA02,

...
! CV
      CALL ADDBLO(VARSOR,ESOMT)          !!! 37 BED EVOLUTION DUE TO DUSPENSION
!
!     VARIABLES 37+1 TO 37+1+NTRAC-1
!
      IF(NTRAC.GT.0) THEN
        DO I=1,NTRAC
...
!
! CV
!     LAYTHI: FROM 37+1+NTRAC   TO 37+1+NTRAC+ NCOUCH-1
!
      IF(NCOUCH.GT.1) THEN
       DO I=1,NCOUCH
         CALL ADDBLO(VARSOR,LAYTHI%ADR(I)%P) 
!          CALL ADDBLO(VARSOR,EPAI(I,:)%P) 
       ENDDO
      ENDIF
!

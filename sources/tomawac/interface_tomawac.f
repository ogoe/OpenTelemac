...
!
      ...
      IMPLICIT NONE
      INTEGER, INTENT(IN)             ::  N
      DOUBLE PRECISION, INTENT(IN)    :: B , A , XM , X0 , X1
        END SUBROUTINE
      END INTERFACE
!
!-----------------------------------------------------------------------
...
!
     ...
     &  AUX1  , AUX2  )
      ...
      DOUBLE PRECISION, INTENT(IN) :: F(NPOIN2,NPLAN,NF)
      DOUBLE PRECISION, INTENT(IN) :: FREQ(NF), DFREQ(NF), FM01(NPOIN2)
...
!
     ...
     &  AUX1  , AUX2  )
      ...
      DOUBLE PRECISION, INTENT(IN) :: TAILF
      DOUBLE PRECISION, INTENT(IN) :: F(NPOIN2,NPLAN,NF)
      DOUBLE PRECISION, INTENT(IN) :: FREQ(NF), DFREQ(NF), FM02(NPOIN2)
      DOUBLE PRECISION, INTENT(INOUT) :: AUX1(NPOIN2), AUX2(NPOIN2)
        END SUBROUTINE
      END INTERFACE
!
...
!
     ...
     &(LISPRD,LT,AT,ISITS,ICOD)
      IMPLICIT NONE
      INTEGER,INTENT(IN)             :: LISPRD,LT,ISITS,ICOD
      DOUBLE PRECISION,INTENT(IN)             :: AT
        END SUBROUTINE
      END INTERFACE
!

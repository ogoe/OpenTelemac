...
'DEPTH_INDUCED_BREAKING_1_(BJ)_HM_COMPUTATION_METHOD' : {
    1:"Hm = GAMMA*D",
    2:"Hm given by the Miche criterium",
  },
'DEPTH_INDUCED_BREAKING_1_(BJ)_CHARACTERISTIC_FREQUENCY' : {
    1:"Frequency Fmoy",
    2:"Frequency F01",
    3:"Frequency F02",
    4:"Frequency Fpic",
...
'DEPTH_INDUCED_BREAKING_2_(TG)_CHARACTERISTIC_FREQUENCY' : {
    1:"Frequency Fmoy",
    2:"Frequency F01",
    3:"Frequency F02",
    4:"Frequency Fpic",
...
'DEPTH_INDUCED_BREAKING_3_(RO)_WAVE_HEIGHT_DISTRIBUTION' : {
    1:"Weibull",
    2:"Rayleigh",
  },
'DEPTH_INDUCED_BREAKING_3_(RO)_CHARACTERISTIC_FREQUENCY' : {
    1:"Frequency Fmoy",
    2:"Frequency F01",
    3:"Frequency F02",
    4:"Frequency Fpic",
...
'DEPTH_INDUCED_BREAKING_4_(IH)_CHARACTERISTIC_FREQUENCY' : {
    1:"Frequency Fmoy",
    2:"Frequency F01",
    3:"Frequency F02",
    4:"Frequency Fpic",
...
DicoCasFrToCata = {
  ...
  "DEFERLEMENT 1 (BJ) MODE DE CALCUL DE QB":"DEPTH_INDUCED_BREAKING_1_(BJ)_QB_COMPUTATION_METHOD",
  "DEFERLEMENT 1 (BJ) MODE DE CALCUL DE HM":"DEPTH_INDUCED_BREAKING_1_(BJ)_HM_COMPUTATION_METHOD",
  "DEFERLEMENT 1 (BJ) CHOIX FREQUENCE CARACTERISTIQUE":"DEPTH_INDUCED_BREAKING_1_(BJ)_CHARACTERISTIC_FREQUENCY",
  "DEFERLEMENT 2 (TG) FONCTION DE PONDERATION":"DEPTH_INDUCED_BREAKING_2_(TG)_WEIGHTING_FUNCTION",
  "DEFERLEMENT 2 (TG) CHOIX FREQUENCE CARACTERISTIQUE":"DEPTH_INDUCED_BREAKING_2_(TG)_CHARACTERISTIC_FREQUENCY",
  "DEFERLEMENT 3 (RO) DISTRIBUTION DES HAUTEURS DE HOULE":"DEPTH_INDUCED_BREAKING_3_(RO)_WAVE_HEIGHT_DISTRIBUTION",
  "DEFERLEMENT 3 (RO) EXPOSANT FONCTION DE PONDERATION":"DEPTH_INDUCED_BREAKING_3_(RO)_EXPONENT_WEIGHTING_FUNCTION",
  "DEFERLEMENT 3 (RO) CHOIX FREQUENCE CARACTERISTIQUE":"DEPTH_INDUCED_BREAKING_3_(RO)_CHARACTERISTIC_FREQUENCY",
  "DEFERLEMENT 4 (IH) CHOIX FREQUENCE CARACTERISTIQUE":"DEPTH_INDUCED_BREAKING_4_(IH)_CHARACTERISTIC_FREQUENCY",
  ...
  "DEFERLEMENT 1 (BJ) CONSTANTE ALPHA":"DEPTH_INDUCED_BREAKING_1_(BJ)_COEFFICIENT_ALPHA",
  "DEFERLEMENT 1 (BJ) CONSTANTE GAMMA1":"DEPTH_INDUCED_BREAKING_1_(BJ)_COEFFICIENT_GAMMA1",
  "DEFERLEMENT 1 (BJ) CONSTANTE GAMMA2":"DEPTH_INDUCED_BREAKING_1_(BJ)_COEFFICIENT_GAMMA2",
  "DEFERLEMENT 2 (TG) CONSTANTE B":"DEPTH_INDUCED_BREAKING_2_(TG)_COEFFICIENT_B",
  "DEFERLEMENT 2 (TG) CONSTANTE GAMMA":"DEPTH_INDUCED_BREAKING_2_(TG)_COEFFICIENT_GAMMA",
  "DEFERLEMENT 3 (RO) CONSTANTE ALPHA":"DEPTH_INDUCED_BREAKING_3_(RO)_COEFFICIENT_ALPHA",
  "DEFERLEMENT 3 (RO) CONSTANTE GAMMA":"DEPTH_INDUCED_BREAKING_3_(RO)_COEFFICIENT_GAMMA",
  "DEFERLEMENT 3 (RO) CONSTANTE GAMMA2":"DEPTH_INDUCED_BREAKING_3_(RO)_COEFFICIENT_GAMMA2",
  "DEFERLEMENT 4 (IH) CONSTANTE BETA0":"DEPTH_INDUCED_BREAKING_4_(IH)_COEFFICIENT_BETA0",
  "DEFERLEMENT 4 (IH) CONSTANTE M2STAR":"DEPTH_INDUCED_BREAKING_4_(IH)_COEFFICIENT_M2STAR",
  ...
  "TRIADS 1 (LTA) CONSTANTE ALPHA":"TRIADS_1_(LTA)_COEFFICIENT_ALPHA",
  "TRIADS 1 (LTA) CONSTANTE RFMLTA":"TRIADS_1_(LTA)_COEFFICIENT_RFMLTA",
  "TRIADS 2 (SPB) CONSTANTE K":"TRIADS_2_(SPB)_COEFFICIENT_K",
  "TRIADS 2 (SPB) BORNE DIRECTIONNELLE INFERIEURE":"TRIADS_2_(SPB)_LOWER_DIRECTIONAL_BOUNDARY",
  "TRIADS 2 (SPB) BORNE DIRECTIONNELLE SUPERIEURE":"TRIADS_2_(SPB)_UPPER_DIRECTIONAL_BOUNDARY",
  ...
  "FICHIER DES RESULTATS 2D":"2D_RESULTS_FILE",
  "FORMAT DU FICHIER DES RESULTATS 2D":"2D_RESULTS_FILE_FORMAT",
  ...
  "BINAIRE DU FICHIER DES RESULTATS PONCTUELS":"PUNCTUAL_RESULTS_FILE_BINARY",
  "BINAIRE DU FICHIER DES COURANTS":"CURRENTS_FILE_BINARY",
  "BINAIRE DU FICHIER DES RESULTATS GLOBAUX":"GLOBAL_RESULT_FILE_BINARY",
  "BINAIRE DU FICHIER DU CALCUL PRECEDENT":"PREVIOUS_COMPUTATION_FILE_BINARY",
  "NUMERO DE VERSION":"RELEASE",
  "BINAIRE DU FICHIER DES VENTS":"WINDS_FILE_BINARY",
  "BINAIRE DU FICHIER BINAIRE 1":"BINARY_FILE_1_BINARY",
  ...
  "BINAIRE DU FICHIER DU NIVEAU DE LA MAREE":"TIDAL_WATER_LEVEL_FILE_BINARY",
  ...
  "FICHIER DES RESULTATS SPECTRES 1D":"1D_SPECTRA_RESULTS_FILE",
...
DicoCasEnToCata = {
  ...
  'DEPTH-INDUCED BREAKING 1 (BJ) QB COMPUTATION METHOD':'DEPTH_INDUCED_BREAKING_1_(BJ)_QB_COMPUTATION_METHOD',
  'DEPTH-INDUCED BREAKING 1 (BJ) HM COMPUTATION METHOD':'DEPTH_INDUCED_BREAKING_1_(BJ)_HM_COMPUTATION_METHOD',
  'DEPTH-INDUCED BREAKING 1 (BJ) CHARACTERISTIC FREQUENCY':'DEPTH_INDUCED_BREAKING_1_(BJ)_CHARACTERISTIC_FREQUENCY',
  'DEPTH-INDUCED BREAKING 2 (TG) WEIGHTING FUNCTION':'DEPTH_INDUCED_BREAKING_2_(TG)_WEIGHTING_FUNCTION',
  'DEPTH-INDUCED BREAKING 2 (TG) CHARACTERISTIC FREQUENCY':'DEPTH_INDUCED_BREAKING_2_(TG)_CHARACTERISTIC_FREQUENCY',
  'DEPTH-INDUCED BREAKING 3 (RO) WAVE HEIGHT DISTRIBUTION':'DEPTH_INDUCED_BREAKING_3_(RO)_WAVE_HEIGHT_DISTRIBUTION',
  'DEPTH-INDUCED BREAKING 3 (RO) EXPONENT WEIGHTING FUNCTION':'DEPTH_INDUCED_BREAKING_3_(RO)_EXPONENT_WEIGHTING_FUNCTION',
  'DEPTH-INDUCED BREAKING 3 (RO) CHARACTERISTIC FREQUENCY':'DEPTH_INDUCED_BREAKING_3_(RO)_CHARACTERISTIC_FREQUENCY',
  'DEPTH-INDUCED BREAKING 4 (IH) CHARACTERISTIC FREQUENCY':'DEPTH_INDUCED_BREAKING_4_(IH)_CHARACTERISTIC_FREQUENCY',
  ...
  'DEPTH-INDUCED BREAKING 1 (BJ) COEFFICIENT ALPHA':'DEPTH_INDUCED_BREAKING_1_(BJ)_COEFFICIENT_ALPHA',
  'DEPTH-INDUCED BREAKING 1 (BJ) COEFFICIENT GAMMA1':'DEPTH_INDUCED_BREAKING_1_(BJ)_COEFFICIENT_GAMMA1',
  'DEPTH-INDUCED BREAKING 1 (BJ) COEFFICIENT GAMMA2':'DEPTH_INDUCED_BREAKING_1_(BJ)_COEFFICIENT_GAMMA2',
  'DEPTH-INDUCED BREAKING 2 (TG) COEFFICIENT B':'DEPTH_INDUCED_BREAKING_2_(TG)_COEFFICIENT_B',
  'DEPTH-INDUCED BREAKING 2 (TG) COEFFICIENT GAMMA':'DEPTH_INDUCED_BREAKING_2_(TG)_COEFFICIENT_GAMMA',
  'DEPTH-INDUCED BREAKING 3 (RO) COEFFICIENT ALPHA':'DEPTH_INDUCED_BREAKING_3_(RO)_COEFFICIENT_ALPHA',
  'DEPTH-INDUCED BREAKING 3 (RO) COEFFICIENT GAMMA':'DEPTH_INDUCED_BREAKING_3_(RO)_COEFFICIENT_GAMMA',
  'DEPTH-INDUCED BREAKING 3 (RO) COEFFICIENT GAMMA2':'DEPTH_INDUCED_BREAKING_3_(RO)_COEFFICIENT_GAMMA2',
  'DEPTH-INDUCED BREAKING 4 (IH) COEFFICIENT BETA0':'DEPTH_INDUCED_BREAKING_4_(IH)_COEFFICIENT_BETA0',
  'DEPTH-INDUCED BREAKING 4 (IH) COEFFICIENT M2STAR':'DEPTH_INDUCED_BREAKING_4_(IH)_COEFFICIENT_M2STAR',
  ...
  'TRIADS 1 (LTA) COEFFICIENT ALPHA':'TRIADS_1_(LTA)_COEFFICIENT_ALPHA',
  'TRIADS 1 (LTA) COEFFICIENT RFMLTA':'TRIADS_1_(LTA)_COEFFICIENT_RFMLTA',
  'TRIADS 2 (SPB) COEFFICIENT K':'TRIADS_2_(SPB)_COEFFICIENT_K',
  'TRIADS 2 (SPB) LOWER DIRECTIONAL BOUNDARY':'TRIADS_2_(SPB)_LOWER_DIRECTIONAL_BOUNDARY',
  'TRIADS 2 (SPB) UPPER DIRECTIONAL BOUNDARY':'TRIADS_2_(SPB)_UPPER_DIRECTIONAL_BOUNDARY',
  ...
  '2D RESULTS FILE':'2D_RESULTS_FILE',
  '2D RESULTS FILE FORMAT':'2D_RESULTS_FILE_FORMAT',
  ...
  'PUNCTUAL RESULTS FILE BINARY':'PUNCTUAL_RESULTS_FILE_BINARY',
  'CURRENTS FILE BINARY':'CURRENTS_FILE_BINARY',
  'GLOBAL RESULT FILE BINARY':'GLOBAL_RESULT_FILE_BINARY',
  'PREVIOUS COMPUTATION FILE BINARY':'PREVIOUS_COMPUTATION_FILE_BINARY',
  'RELEASE':'RELEASE',
  'WINDS FILE BINARY':'WINDS_FILE_BINARY',
  'BINARY FILE 1 BINARY':'BINARY_FILE_1_BINARY',
  ...
  'TIDAL WATER LEVEL FILE BINARY':'TIDAL_WATER_LEVEL_FILE_BINARY',
  ...
  '1D SPECTRA RESULTS FILE':'1D_SPECTRA_RESULTS_FILE',

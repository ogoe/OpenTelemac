...
!
      ...
      CHARACTER(LEN=144) TITRE
      CHARACTER(LEN=144) NOMGEO,NOMLIM
      CHARACTER(LEN=144) NOMSOU,NOMMAB,NOMCOU,NOMSAL,NOMTEM
      CHARACTER(LEN=144) NOMINI,NOMVEB,NOMMAF,NOMVEL,NOMVIS

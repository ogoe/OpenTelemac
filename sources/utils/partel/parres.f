...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
      ...
      CHARACTER(LEN=8), INTENT(IN) :: GEOFORMAT
      CHARACTER(LEN=8), INTENT(IN) :: INPFORMAT
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
!
      INTEGER :: NGEO=7,NINP=8,NINP_PAR=9
!     CHARACTER(LEN=250) :: WDIR
!     INTEGER IPID,NCSIZE,NCAR
      CHARACTER(LEN=MAXLENHARD) :: NAMEGEO_PAR
      CHARACTER(LEN=MAXLENHARD) :: NAMEINP_PAR
      INTEGER :: I,J,IERR
      INTEGER :: IPARTB,IPARTE,IPART
...
!     INITIALISING MPI
!
!     CALL P_INIT(WDIR,NCAR,IPID,NCSIZE)
!     CALL CHECK_CALL(IERR,'PARRES:MPI_INIT')
!     ! TODO: SEE IF REALLY USEFUL
!     IF(NCSIZE.GT.NPARTS) THEN
!       WRITE(LU,*) 'TOO MANY PROCESSORS FOR THE NUMBER OF FILE ',
!    &              'TO PARTIONNE'
!       CALL PLANTE(1)
!       STOP
!     ENDIF
!     ! COMPUTE THE LIST OF FILES TO READ
!     IF(IPID.EQ.NCSIZE-1) THEN
!       IPARTB = (NPARTS/NCSIZE)*IPID
!       IPARTE = NPARTS
!     ELSE
!       IPARTB = (NPARTS/NCSIZE)*IPID
!       IPARTE = (NPARTS/NCSIZE)*(IPID+1) -1
!     ENDIF
!     WRITE(LU,*) IPID,'IPARTB',IPARTB,'IPARTE',IPARTE
...
!        
        ...
        CALL CLOSE_MESH(INPFORMAT,NINP_PAR,IERR)

...
!  FORMATS
!
69    FORMAT(/,1X,'IL Y A ',1I4,' ILE(S) DANS LE DOMAINE')
169   FORMAT(/,1X,'THERE IS ',1I4,' ISLAND(S) IN THE DOMAIN')
70    FORMAT(/,1X,'IL Y A ',1I4,' FRONTIERE(S) LIQUIDE(S) :')
170   FORMAT(/,1X,'THERE IS ',1I4,' LIQUID BOUNDARIES:')
100   FORMAT(/,1X,'IL Y A ',1I4,' FRONTIERE(S) SOLIDE(S) :')
101   FORMAT(/,1X,'THERE IS ',1I4,' SOLID BOUNDARIES:')

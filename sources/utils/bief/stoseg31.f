...
500     FORMAT(1X,'STOSEG31 (BIEF) : ELEMENT NON PREVU : ',1I6)
...
!      IF(NSEGBOR.NE.NSEBOR) THEN
      IF(NSEGBOR.LT.NSEBOR) THEN
        IF (LNG.EQ.1) WRITE(LU,504) NSEBOR,NSEGBOR
        IF (LNG.EQ.2) WRITE(LU,505) NSEBOR,NSEGBOR
504    FORMAT(1X,'STOSEG31 (BIEF) : MAUVAIS NB DE SEGMENTS DE BORDS : ',
     &  1I12,' AU LIEU DE ',1I12,' ESTIMES')

...
!
      RETURN
!
1000  FORMAT(1X,'MV0606_2 (BIEF) : TERMES EXTRADIAG. TYPE INCONNU: ',A1)
1001  FORMAT(1X,'MV0606_2 (BIEF) : EXTRADIAG. TERMS  UNKNOWN TYPE: ',A1)
2000  FORMAT(1X,'MV0606_2 (BIEF) : DIAGONALE : TYPE INCONNU: ',A1)
2001  FORMAT(1X,'MV0606_2 (BIEF) : DIAGONAL : UNKNOWN TYPE : ',A1)
3000  FORMAT(1X,'MV0606_2 (BIEF) : OPERATION INCONNUE : ',A8)

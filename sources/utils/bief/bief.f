...
!
        ...
        END FUNCTION
!
        INTEGER FUNCTION BIEF_NBSEGEL(IELM,MESH,REFINE)
          USE BIEF_DEF
          USE DECLARATIONS_SPECIAL
          IMPLICIT NONE
          INTEGER, INTENT(IN) :: IELM
...
!
     ...
     &                TARGET,OPTIONAL :: FLULIMEBE(MESH%NELEM,3)
        END SUBROUTINE
!

...
!
        SUBROUTINE ALMESH
     &(MESH,NOM,IELM,SPHERI,CFG,FFORMAT,NFIC,EQUA,NPLAN,NPMAX,NPTFRX,
...
!
     ...
     & GIVEN_FLUX,FLUX_GIVEN,MAXADV)
      ...
      TYPE(BIEF_OBJ), INTENT(IN)    :: S,VOLU2D,V2DPAR,UNSV2D
...
!
     ...
     & NITMAX)
      ...
      TYPE(BIEF_OBJ), INTENT(INOUT)   :: F,SM,HNT,HT,FBOR
...
!
        ...
        END SUBROUTINE
!
        SUBROUTINE MAKE_ELTCAR(ELTCAR,IKLE,NPOIN2,NELEM2,NELMAX,KNOLG,
     &                         ISCORE,MESH,NPLAN,IELM)
          USE BIEF_DEF
          IMPLICIT NONE
...
!
     ...
     &                             LATI0,LONGI0,Z)
        ...
        END SUBROUTINE
!
        SUBROUTINE READ_DATA(FFORMAT,NFIC,VAR_VALUE,VAR_NAME,NPOIN,
     &                       IERR,RECORD,TIME)
          INTEGER,           INTENT(IN)    :: NFIC
          INTEGER,           INTENT(IN)    :: NPOIN
          CHARACTER(LEN=8),  INTENT(IN)    :: FFORMAT
...
!
     ...
     & IOPT2,FLBORTRA,SURNIT,MESH,SF,RAIN,PLUIE,TRAIN)
      ...
      DOUBLE PRECISION, INTENT(IN)    :: FXBOR(NPTFR),PLUIE(NPOIN)

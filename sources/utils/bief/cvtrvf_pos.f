...
!
      ...
      ENDIF
!
101   FORMAT(' CVTRVF_POS (SCHEMA ERIA, 15) : ',1I3,' ITERATIONS')
201   FORMAT(' CVTRVF_POS (SCHEMA NERD, 13 OU 14) : ',1I3,' ITERATIONS')
102   FORMAT(' CVTRVF_POS (SCHEME ERIA, 15): ',1I3,' ITERATIONS')
202   FORMAT(' CVTRVF_POS (SCHEME NERD, 13 OR 14): ',1I3,' ITERATIONS')
!
!-----------------------------------------------------------------------
!
      RETURN

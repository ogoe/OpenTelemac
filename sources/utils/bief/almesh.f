...
!
     ...
     &    NELEM,NPTFR,NPTIR,NDP,NNPLAN,TYP_BND_ELEM,NNELEB)
!
...
!
     ...
     &                   IELM0,BIEF_NBPEL(IELM,MESH),1,MESH)
      ENDIF
      WRITE(LU,*) "DIMENSION 1 OF IKLE: ", MESH%IKLE%DIM1
      WRITE(LU,*) "IELM0: ", IELM0
      ALLOCATE(MESH%KLEI)
      IF(CONV) THEN

...
!
      IF(NWEIRS.GT.0) THEN
        ...
        ELSEIF(TYPSEUIL.EQ.2) THEN
          CALL BIEF_DEALLOBJ(WDIG  )
          CALL BIEF_DEALLOBJ(NDGA2 )
          CALL BIEF_DEALLOBJ(NDGB2 )
          CALL BIEF_DEALLOBJ(QWA   )
          CALL BIEF_DEALLOBJ(QWB   )
          CALL BIEF_DEALLOBJ(UWEIRA)
          CALL BIEF_DEALLOBJ(UWEIRB)
          CALL BIEF_DEALLOBJ(VWEIRA)
          CALL BIEF_DEALLOBJ(VWEIRB)
          CALL BIEF_DEALLOBJ(QP0   )
          CALL BIEF_DEALLOBJ(TWEIRA)
          CALL BIEF_DEALLOBJ(TWEIRB)
        ENDIF
      ENDIF
!
!     flusec_t2d.f

...
!     15/03/2016: 46
!
      INTEGER, PARAMETER :: MAXLU_T2D = 46
!
...
!
      INTEGER OPTPSI
!
!     ADVECTION SCHEME OPTIONS FOR VELOCITY AND K-EPSILON
!
...
!
      INTEGER HROPT
!
!     RAINFALL-RUNOFF OPTION
!
      INTEGER RUNOFFOPT
!
!     ANTECEDENT MOISTURE CONDITION (FOR SCS_CN MODEL)
!
      INTEGER AMC
!-----------------------------------------------------------------------
!
...
!
      ...
      CHARACTER*9 CHOIX_RFS(MAXVALUE_RFS),LASTWHAT_RFS
...
!     AUTOMATIC EX ARRAYS!!!!!!
      ...
      CHARACTER*9 CHOIX_RFF(MAXVALUE_RFF),LASTWHAT_RFF

...
!
      INTEGER IELM0,IELM1,IELMH,IELMU,IELMT,IELMK,IELME,IELMNU
!
!     MATRIX STORAGE
!
      INTEGER OPTASS
...
!     AUTOMATIC EX ARRAYS!!!!!!
      ...
      ! bord_tide_misc
      INTEGER, PARAMETER   :: MISC_NCMX_BTM = 54
...
!     TYPE COMPONENTS MUST BE SAVED
      SAVE :: DT, DTINI, GRAV, FFON, FCOR, FAIR, FUAIR, FVAIR, WIND_SPD,
     &     DIFNU, TETAT, PROPNU, BORNES, TETAC, TETAU, TETAD, AGGLOC,
     &     AGGLOU, AGGLOW, HMIN, REDUC, HAULIN, ROEAU, LAMBD0, SB,
     &     COTINI, HAUTIN, COSUPG, CRIPER, TMOY, NORD, ELDER, PHI0,
     &     AGGLOT, DUREE, CFLWTD, HWIND, HNEG, TETAZCOMP, TAFBGN, TAFEND
     &     , AT, AT0, PERIAF, TOLEST, GAMMA, RAIN_MMPD, COETSUNAMI,
     &     CTIDE, CTIDEV, MSL, HREC, DALGAE, RALGAE, EALGAE,
     &     PATMOS_VALUE, SEC_AS, SEC_DS, KARMAN, RAIN_HDUR, SLVPRO, SLVK
     &     , SLVEP, DP, SP, FRTAB, TL2_RFS, LASTAT_RFS, FLUX1_OLD,
     &     MASSE0, MASSE1, MASSE2, MASENT, MASSET, TL1_RFF, TL2_RFF,
     &     LASTAT_RFF, MASTR0_BT1, MASTR1_BT1, MASTR2_BT1, MASTEN_BT1,
     &     MASTOU_BT1, DIRTOT_BT1, NF_PRERES, NDEF, AT2_METEO, TL1_RFS,
     &     AT1_METEO, FUAIR1_METEO, FUAIR2_METEO, FVAIR1_METEO,
     &     FVAIR2_METEO, TIME_FLUSECT2D, SLVNU, FFMN2, UPVM2, UPVN2,
     &     UPVS2, FFM4, FM2, FS2, FN2, FM4
!##< JR @ RWTH
!

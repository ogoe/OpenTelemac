...
!
      INTEGER TIDALTYPE,BND_TIDE(MAXFRO)
!
...
!
      DOUBLE PRECISION, TARGET :: DEBIT(MAXFRO)
!
!     PRESCRIBED ELEVATIONS
!
      DOUBLE PRECISION, TARGET :: COTE(MAXFRO)
!
...
!
      DOUBLE PRECISION, TARGET :: FLUX_BOUNDARIES(MAXFRO)
!

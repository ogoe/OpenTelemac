...
!
      CALL ALLBLO(TB2,'TB2   ')
      IF(YESIMP) THEN
!       SEE CVTRVF, 7 IS THE VALUE CORRESPONDING TO HARDCODED SOLVER 4 
        CALL BIEF_ALLVEC_IN_BLOCK(TB2,7,1,'TB2   ',IELMX,1,2,MESH)
      ELSE
        CALL BIEF_ALLVEC_IN_BLOCK(TB2,7,1,'TB2   ',    0,1,0,MESH)
      ENDIF
!

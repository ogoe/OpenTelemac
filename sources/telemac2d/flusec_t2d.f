...
!
      TYPE :: FLUXLINE
        INTEGER, DIMENSION(MAXEDGES) :: SECTIONIDS
        INTEGER, DIMENSION(MAXEDGES) :: DIRECTION 
        INTEGER                      :: NOFSECTIONS
      END TYPE FLUXLINE
!
      INTEGER IELEM,IEL,IELMH,I,INP,ISEG,ISEC,MYPOS,NUMBEROFLINES,IERR
      INTEGER MAXNUMBEROFCLASSES
!
      DOUBLE PRECISION, DIMENSION (2) :: SEG1,SEG2,POINT
      DOUBLE PRECISION :: SEGMENTFLUX,MASS,MASSTOTAL,TIME,SIGN1,SIGN2

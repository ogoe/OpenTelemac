...
!
     ...
     &                            TIME_FLUSECT2D,
     &                            POTFLX_FLUSECT2D,POTVOLFLUX_FLUSECT2D
!
      IMPLICIT NONE
!
!+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
...
!
        ...
        ALLOCATE(POTFLX_FLUSECT2D(NUMBEROFLINES_FLUSECT2D,1),STAT=IERR)
        ALLOCATE(POTVOLFLUX_FLUSECT2D(NUMBEROFLINES_FLUSECT2D,1),
     &           STAT=IERR)

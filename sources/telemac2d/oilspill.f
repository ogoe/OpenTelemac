...
!+                AND USES 'OILSPILL STEERING FILE'.
!
!note     LOGICAL UNIT OF OILSPILL STEERING FILE IS: T2D_FILES(T2DMIG)%LU
!
...
3       CONTINUE
     ...
     &          'DU FICHIER DE COMMANDE OILSPILL'
        ENDIF
        IF(LNG.EQ.2) THEN
          WRITE(LU,*) 'OIL_SPILL_2D: PROBLEM TO READ ',
     &          'THE INPUT OILSPILL STEERING FILE'
        ENDIF
        CALL PLANTE(1)
        STOP    
...
!| T3DMIG     |-->| LOGICAL UNIT OF OILSPILL FILE

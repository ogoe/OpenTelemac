...
C                                                                       
23    FORMAT(1X,'FM3SEL : NOMBRE DE POINTS DU MAILLAGE : ',1I6,/,1X,    
     *          '         NOMBRE DE POINTS DE FRONTIERE: ',1I6,/,1X,    
     *          '         DONNEES ERRONEES, ARRET DU PROGRAMME')        
24    FORMAT(1X,'FM3SEL : NUMBER OF POINTS IN THE MESH: ',1I6,/,1X,     
     *          '         NUMBER OF BOUNDARY POINTS: ',1I6,/,1X,        
     *          '         WRONG DATA, PROGRAMME STOPPED')               
300   FORMAT(1X,//,1X,'TITRE: ',A72,/)                                  
301   FORMAT(1X,//,1X,'TITLE: ',A72,/)                                  
500   FORMAT(1X,'NOMBRE DE POINTS FRONTIERE: ',1I4,/,1X,                
     *'NOMBRE D''ELEMENTS:',1I6,/,1X,'NOMBRE REEL DE POINTS:',1I6)      
501   FORMAT(1X,'NUMBER OF BOUNDARY POINTS: ',1I4,/,1X,                 
     *'NUMBER OF ELEMENTS:',1I6,/,1X,'NUMBER OF POINTS:',1I6)           
C                                                                       
C-----------------------------------------------------------------------
C                                                                       
      RETURN                                                            

...
!----------------------------------------------------------------------
!
      NAMECLM(I_LENCLI+1:I_LENCLI+11) = EXTENS(NPARTS-1,ID)
!
...
!
      ...
      IF (ERR.NE.0) CALL ALLOER (LU, 'IRAND_P')
!
      IF (ERR.NE.0) CALL ALLOER (LU, 'F_P')
...
!
      NAMEOUT(I_LENINP+1:I_LENINP+11) = EXTENS(NPARTS-1,ID)
!

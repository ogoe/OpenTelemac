...
!+        25/03/2011
!+
!+   ADDING A FILE FRONT_GLOB.DAT
!+   FOR THOMPSON BOUNDARY CONDITIONS IN PARALLEL
!
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
!
...
!     MAXIMUM NUMBER OF HALO, IN THE PARALLEL VERSION THE NUMBER 
!     OF HALO WILL BE DIRECTLY COMPUTED
...
80      CONTINUE
      ...
      OPEN(UNIT=234,FILE='FRONT_GLOB.DAT',POSITION='APPEND')
      DO K = 1 , NFRLIQ
         WRITE(234,*) DEBLIQ(K),FINLIQ(K)
      END DO
      CLOSE(234)

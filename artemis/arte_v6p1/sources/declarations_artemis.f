...
!>  <br><table>
!>     <tr><th> Internal(s)
!>    </th><td> ALEMON, ALEMUL, ALFABJ, ALFAP, ALFAPT, AM1, AM2, AM3, 
!>    </th><td> APHI1B, APHI2B, APHI3B, APHI4B, ARTBI1, ARTBI2, ARTCAS, 
!>    </th><td> ARTCLI, ARTFO1, ARTFO2, ARTFON, ARTGEO, ARTRBI, ARTREF, 
!>    </th><td> ARTRES, ARTRFO, ART_FILES, BALAYE, BINGEO, BINRES, BM1,
!>    </th><td> BM2, BPHI1B, BPHI2B, BPHI3B, BPHI4B, C, CDTINI, CG, CGT,
!>    </th><td> COTINI, COURANT, CPHI1B, CPHI2B, CPHI3B, CPHI4B, CTT,
!>    </th><td> CURRENTX, CURRENTY, CV1, CV2, DALE, DEBLIQ, DEBSOL, 
!>    </th><td> DEFERL, DIAM50, DIAM90, DIM, DISESP, DPHI1B, DPHI2B, 
!>    </th><td> DPHI3B, DPHI4B, ENTFW, ENTREG, ENTRUG, EPSDIS, EQUA, 
!>    </th><td> EXPOS, FFON, FINLIQ, FINSOL, FORMFR, FROTTE, FW, FWCOEF,
!>    </th><td> FX, FY, GAMMA, GAMMAS, GDALLY, GRAV, H, HALE, HAUTIN, HB,
!>    </th><td> HBT, HHO, HMIN, HMU, HMUANC, IBREAK, IELM, IELM0, IELMB,
!>    </th><td> IELMB0, IKLE, INCI, INFOGR, ISOLVE, IT1, IT2, IT3,
!>    </th><td> I_ORIG, J_ORIG, K, KDALLY, KFROT, KN1, KN2, 
!>    </th><td> KNANC1, KNANC2, KP1BOR_TOT, KT, LEOPRD, LIDIR, LIDIRT,
!>    </th><td> LIHBOR, LIHBORT, LISFON, LISHOU, LISPRD, LISTIN, LIUBOR,
!>    </th><td> LIVBOR, LV, LVMAC, MARDAT, MARTIM, MASK1, MASK1T, MASK2,
!>    </th><td> MASK2T, MASK3, MASK3T, MASK4, MASK4T, MASKEL, MAT,
!>    </th><td> MAXFRO, MAXLU_ART, MAXVAR, MBOR, MCOS, MESH, MSIN, MSK,
!>    </th><td> MU, MU2, MVEAU, MVSED, MXELVS, MXPTVS, NBOR_TOT, NDALE,
!>    </th><td> NELEM, NELMAX, NFRLIQ, NFRSOL, NITDIS, NITMAX, NPALE,
!>    </th><td> NPMAX, NPOIN, NPOIN_TOT, NPRIV, NPTFR, NPTFRX, NPTFR_TOT,
!>    </th><td> NUMLIQ, OMEGA, OPTASS, PALE, PER, PERDEB, PERFIN, PERPAS,
!>    </th><td> PERPIC, PHAS, PHIB, PHII, PHIIB, PHIR, PHIRB, PMAX, PMIN,
!>    </th><td> PRIVE, PRODUC, PTINIG, PTINIL, QB, REGIDO, RELAX, RELDIS,
!>    </th><td> RHS, RICOEF, RP, RPT, S, SBID, SLVART, SORIMP, SORLEO,
!>    </th><td> SPHERI, STDGEO, STDRES, SXX, SXY, SYY, T01, T02, T1, T10,
!>    </th><td> T11, T12, T2, T3, T4, T5, T6, T7, T8, T9, TB, TBBD, TBD1,
!>    </th><td> TBD2, TBD3, TBD4, TETAB, TETABT, TETAH, TETAP, TETAPT,
!>    </th><td> TETMAX, TETMIN, TEXTE, TEXTPR, TITCAS, TM, TYPELM, U0,
!>    </th><td> UC, UNK, V0, VALID, VARCLA, VARDES, VARIMP, VARSOR, VC,
!>    </th><td> VISCO, W1, WR, X, XT, Y, YT, ZF
!>   </td></tr>
!>     </table>

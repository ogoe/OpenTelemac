...
#
#------------------------Systeme TELEMAC V5P6--------------runcode.pl--
#
...
#
#          date    : Avril 2005 - SOGREAH - Système TELEMAC V5.5
#          objet   : Traitement du passage des variables d'environnement de protection
#                    pour le parallélisme.
#
#          date    : Décembre 2006 - LNHE - Système TELEMAC 5.6
#          objet   : Traitement du numéro de la version dans le nom de l'executable local
#
#------------------------Systeme TELEMAC V5P6--------------------------
#
use File::Copy;
use File::Path;
use File::Basename;
...
if ($NCSIZE < 1 && $CALCIUM ne "OUI" )
  ...
  {
  	$LIB_SYS = "";
  	#$LIB_SYS = "advapi32.lib netapi32.lib";
  }
  $LIB_CALCIUM = "";
  }
else { #parallele
...
#                " netapi32.lib uuid.lib oldnames.lib dfconsol.lib";
     $LIB_SYS = " $LIB_SYS wsock32.lib kernel32.lib gdi32.lib winspool.lib".
                " comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib".
                " netapi32.lib uuid.lib oldnames.lib ifconsol.lib";
    }
...
sub ecrire_FicTitrVal {
  ...
  $ligaff="$ligaff".
  "                                                                           ";
  substr($ligaff,39,1)=":";                                 # ':' en colonne 40
  substr($ligaff,41,25)=basename($_[2]);
  print " - $ligaff\n";
}
...
#- Traitement de l'option UNCPATH
    ...
    print F2 "exe $REP$ps$EXEFILE\n";
# Ajout P.Lang/S.Bourban
    my $STELPn="STELP1=$ENV{\"STELP1\"}\|STELP2=$ENV{\"STELP2\"}\|STELP3=$ENV{\"STELP3\"}";
    print F2 "env $STELPn \n";
    print F2 "hosts\n";
  }

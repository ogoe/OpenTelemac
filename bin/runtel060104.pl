...
return;
  printf "\n";
  printf "=====================================================================\n";
  printf " Telemac System V5P3  delivered from LNHE DER EDF on 7th March 2003 \n";
  printf " Perl scripts modified by jaj for BAW  Wed Mar 19 17:07:07 MET 2003 \n";
  printf "=====================================================================\n";
  printf "$_[0]\n";
  printf "\n";
}
